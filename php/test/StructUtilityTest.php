...
// Nofrixion SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = NofrixionOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(NofrixionOmni::structfix($now, Struct::undef()))
                        !== json_encode(NofrixionOmni::structfix($val, Struct::undef()))) {
