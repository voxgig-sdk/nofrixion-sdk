...
class MandateDirectTest extends TestCase
{
    public function test_direct_load_mandate(): void
    {
        $setup = mandate_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-mandate", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
