...
class PayoutMetricDirectTest extends TestCase
{
    public function test_direct_load_payout_metric(): void
    {
        $setup = payout_metric_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-payout_metric", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
