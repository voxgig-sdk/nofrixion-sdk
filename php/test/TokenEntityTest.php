...
class TokenEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set NOFRIXION_TEST_TOKEN_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
        ...
        $this->assertNotNull($token_ref01_data["id"]);
...
function token_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("NOFRIXION_TEST_TOKEN_ENTID");
