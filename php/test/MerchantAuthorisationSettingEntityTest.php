...
class MerchantAuthorisationSettingEntityTest extends TestCase
{
    ...
    public function test_stream(): void
    {
        ...
        $seen = iterator_to_array($base->MerchantAuthorisationSetting(null)->stream("list", null, null), false);
        ...
        if (isset($cfg["feature"]) && is_array($cfg["feature"]) && isset($cfg["feature"]["streaming"])) {
            ...
            $got = [];
            foreach ($sdk->MerchantAuthorisationSetting(null)->stream("list", null, null) as $item) {
