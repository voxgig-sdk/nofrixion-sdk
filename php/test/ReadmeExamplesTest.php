...
//      EXECUTED offline in seeded test mode (NofrixionSDK::test)
...
{
    private const SDK_CLASS = 'NofrixionSDK';
    ...
    private const SDK_BASE = 'nofrixion_sdk';
