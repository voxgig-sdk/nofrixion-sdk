...
class PayrunEntityTest extends TestCase
{
    ...
    public function test_stream(): void
    {
        ...
        $seen = iterator_to_array($base->Payrun(null)->stream("list", null, null), false);
        ...
        if (isset($cfg["feature"]) && is_array($cfg["feature"]) && isset($cfg["feature"]["streaming"])) {
            ...
            $got = [];
            foreach ($sdk->Payrun(null)->stream("list", null, null) as $item) {
    ...
    public function test_basic_flow(): void
    {
        ...
        $payrun_ref01_data = Helpers::to_map(is_object($payrun_ref01_data_result) && method_exists($payrun_ref01_data_result, 'data_get') ? $payrun_ref01_data_result->data_get() : $payrun_ref01_data_result);
        ...
        $payrun_ref01_resdata_up0 = Helpers::to_map(is_object($payrun_ref01_resdata_up0_result) && method_exists($payrun_ref01_resdata_up0_result, 'data_get') ? $payrun_ref01_resdata_up0_result->data_get() : $payrun_ref01_resdata_up0_result);
        ...
        $payrun_ref01_data_dt0_load_result = Helpers::to_map(is_object($payrun_ref01_data_dt0_loaded) && method_exists($payrun_ref01_data_dt0_loaded, 'data_get') ? $payrun_ref01_data_dt0_loaded->data_get() : $payrun_ref01_data_dt0_loaded);
