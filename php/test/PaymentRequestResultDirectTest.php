...
class PaymentRequestResultDirectTest extends TestCase
{
    public function test_direct_list_payment_request_result(): void
    {
        $setup = payment_request_result_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-payment_request_result", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
