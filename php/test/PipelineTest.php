...
{
    private static function utility(): NofrixionUtility
    {
        return new NofrixionUtility();
    }
    ...
    private static function ctx(array $over = []): NofrixionContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new NofrixionContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new NofrixionOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof NofrixionError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new NofrixionOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = NofrixionMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new NofrixionOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = NofrixionMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new NofrixionOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = NofrixionMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new NofrixionSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = NofrixionMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new NofrixionResponse([]),
            'result' => new NofrixionResult([]),
        ]);
        [, $err] = NofrixionMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new NofrixionSpec([]),
            'response' => null,
            'result' => new NofrixionResult([]),
        ]);
        [, $err] = NofrixionMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new NofrixionSpec(['step' => 's']),
            'response' => new NofrixionResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new NofrixionResult([]),
        ]);
        [, $err] = NofrixionMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new NofrixionSpec(['step' => 's']),
            'response' => new NofrixionResponse(self::resp(200, ['v' => 1])),
            'result' => new NofrixionResult([]),
        ]);
        [, $err] = NofrixionMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new NofrixionSpec(['step' => 's']),
            'response' => new NofrixionResponse(self::resp(200, ['v' => 2])),
            'result' => new NofrixionResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        NofrixionMakeResponse::call($ctx);
    ...
    {
        $preset = new NofrixionResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new NofrixionSpec([]),
            'response' => new NofrixionResponse([]),
            'result' => new NofrixionResult([]),
        ...
        [$got, $err] = NofrixionMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new NofrixionResult([])]);
        [, $err] = NofrixionMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new NofrixionSpec([]), 'result' => null]);
        [, $err] = NofrixionMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new NofrixionSpec(['step' => 's']),
            'result' => new NofrixionResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new NofrixionOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = NofrixionMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new NofrixionSpec(['step' => 's']),
            'result' => new NofrixionResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new NofrixionOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = NofrixionMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new NofrixionResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new NofrixionSpec([]),
            'result' => new NofrixionResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = NofrixionMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = NofrixionMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new NofrixionError('boom', 'boom');
        $utility->fetcher = function (NofrixionContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new NofrixionSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = NofrixionMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (NofrixionContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = NofrixionMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(NofrixionResponse::class, $response);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (NofrixionContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new NofrixionSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = NofrixionMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new NofrixionResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new NofrixionSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = NofrixionMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = NofrixionMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = NofrixionMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new NofrixionResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, NofrixionDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new NofrixionResult(['ok' => false])]);
        $this->expectException(NofrixionError::class);
        NofrixionDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new NofrixionResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', NofrixionMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        NofrixionMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new NofrixionBaseFeature();
        $b = new NofrixionBaseFeature();
        NofrixionFeatureAdd::call($ctx, $a);
        NofrixionFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): NofrixionBaseFeature
    {
        $f = new NofrixionBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        NofrixionFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): NofrixionContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new NofrixionSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = NofrixionPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new NofrixionResponse(['headers' => null]),
            'result' => new NofrixionResult([]),
        ]);
        NofrixionResultHeaders::call($ctx);
