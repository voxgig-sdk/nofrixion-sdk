...
class NofrixionTestRunner
{
    ...
    {
        $live = self::getenv('NOFRIXION_TEST_LIVE');
        $override = self::getenv('NOFRIXION_TEST_OVERRIDE');
        ...
        $explain = self::getenv('NOFRIXION_TEST_EXPLAIN');
...
class_alias('NofrixionTestRunner', 'Runner');
class_alias('NofrixionHelpers', 'Helpers');
