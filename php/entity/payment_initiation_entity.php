...
class PaymentInitiationEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new PaymentInitiationEntity($this->_client, $opts);
    }

    /**
     * @param PaymentInitiation|array $args PaymentInitiation data (assoc-array) to store.
     */
    ...
    /**
     * @return PaymentInitiation|array The current PaymentInitiation data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of PaymentInitiation fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of PaymentInitiation fields).
     */
    ...
    /**
     * Create a new PaymentInitiation.
     *
     * @param PaymentInitiationCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed PaymentInitiationCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PaymentInitiation|array The created PaymentInitiation as an assoc-array at the
