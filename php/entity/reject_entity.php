...
class RejectEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new RejectEntity($this->_client, $opts);
    }

    /**
     * @param Reject|array $args Reject data (assoc-array) to store.
     */
    ...
    /**
     * @return Reject|array The current Reject data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Reject fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Reject fields).
     */
    ...
    /**
     * Update an existing Reject.
     *
     * @param RejectUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed RejectUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Reject|array The updated Reject as an assoc-array at the
