...
class MerchantPayByBankSettingEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "merchant_pay_by_bank_setting";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new MerchantPayByBankSettingEntity($this->_client, $opts);
    }

    /**
     * @param MerchantPayByBankSetting|array $args MerchantPayByBankSetting data (assoc-array) to store.
     */
    ...
    /**
     * @return MerchantPayByBankSetting|array The current MerchantPayByBankSetting data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of MerchantPayByBankSetting fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of MerchantPayByBankSetting fields).
     */
    ...
    /**
     * List MerchantPayByBankSetting items matching the given filter.
     *
     * @param MerchantPayByBankSettingListMatch|array|null $reqmatch Match filter (any subset
     *   of MerchantPayByBankSetting fields) as an assoc-array; MerchantPayByBankSettingListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return MerchantPayByBankSetting[]|array A list of MerchantPayByBankSetting items as assoc-arrays at
