...
class PayrunEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new PayrunEntity($this->_client, $opts);
    }

    /**
     * @param Payrun|array $args Payrun data (assoc-array) to store.
     */
    ...
    /**
     * @return Payrun|array The current Payrun data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Payrun fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Payrun fields).
     */
     ...
     * Create a new Payrun.
     *
     * @param PayrunCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed PayrunCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Payrun|array The created Payrun as an assoc-array at the
     *   SDK boundary; throws NofrixionError on failure (item-5 convention).
     */
     ...
     *
     * @param PayrunUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed PayrunUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Payrun|array The updated Payrun as an assoc-array at the
     *   SDK boundary; throws NofrixionError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an Payrun matching the given criteria.
     *
     * @param PayrunRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; PayrunRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Payrun|array The removed Payrun as an assoc-array at the
     *   SDK boundary; throws NofrixionError on failure (item-5 convention).
     */
