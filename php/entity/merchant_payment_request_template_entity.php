...
// Nofrixion SDK MerchantPaymentRequestTemplate entity
...
class MerchantPaymentRequestTemplateEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "merchant_payment_request_template";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new MerchantPaymentRequestTemplateEntity($this->_client, $opts);
    }

    /**
     * @param MerchantPaymentRequestTemplate|array $args MerchantPaymentRequestTemplate data (assoc-array) to store.
     */
    ...
    /**
     * @return MerchantPaymentRequestTemplate|array The current MerchantPaymentRequestTemplate data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of MerchantPaymentRequestTemplate fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of MerchantPaymentRequestTemplate fields).
     */
    ...
    /**
     * Load a single MerchantPaymentRequestTemplate.
     *
     * @param MerchantPaymentRequestTemplateLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed MerchantPaymentRequestTemplateLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return MerchantPaymentRequestTemplate|array The loaded MerchantPaymentRequestTemplate as an assoc-array at the
    ...
    /**
     * List MerchantPaymentRequestTemplate items matching the given filter.
     *
     * @param MerchantPaymentRequestTemplateListMatch|array|null $reqmatch Match filter (any subset
     *   of MerchantPaymentRequestTemplate fields) as an assoc-array; MerchantPaymentRequestTemplateListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return MerchantPaymentRequestTemplate[]|array A list of MerchantPaymentRequestTemplate items as assoc-arrays at
    ...
    /**
     * Update an existing MerchantPaymentRequestTemplate.
     *
     * @param MerchantPaymentRequestTemplateUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed MerchantPaymentRequestTemplateUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return MerchantPaymentRequestTemplate|array The updated MerchantPaymentRequestTemplate as an assoc-array at the
     *   SDK boundary; throws NofrixionError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an MerchantPaymentRequestTemplate matching the given criteria.
     *
     * @param MerchantPaymentRequestTemplateRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; MerchantPaymentRequestTemplateRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return MerchantPaymentRequestTemplate|array The removed MerchantPaymentRequestTemplate as an assoc-array at the
     *   SDK boundary; throws NofrixionError on failure (item-5 convention).
     */
