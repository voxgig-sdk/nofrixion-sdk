...
class EnableEntity
{
    ...
    /**
     * Update an existing Enable.
     *
     * @param EnableUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed EnableUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Enable|array The updated Enable as an assoc-array at the
