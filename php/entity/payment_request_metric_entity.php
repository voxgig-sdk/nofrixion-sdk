...
class PaymentRequestMetricEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "payment_request_metric";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new PaymentRequestMetricEntity($this->_client, $opts);
    }

    /**
     * @param PaymentRequestMetric|array $args PaymentRequestMetric data (assoc-array) to store.
     */
    ...
    /**
     * @return PaymentRequestMetric|array The current PaymentRequestMetric data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of PaymentRequestMetric fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of PaymentRequestMetric fields).
     */
    ...
    /**
     * Load a single PaymentRequestMetric.
     *
     * @param PaymentRequestMetricLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed PaymentRequestMetricLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PaymentRequestMetric|array The loaded PaymentRequestMetric as an assoc-array at the
