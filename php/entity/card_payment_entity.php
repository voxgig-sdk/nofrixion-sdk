...
class CardPaymentEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new CardPaymentEntity($this->_client, $opts);
    }

    /**
     * @param CardPayment|array $args CardPayment data (assoc-array) to store.
     */
    ...
    /**
     * @return CardPayment|array The current CardPayment data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of CardPayment fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of CardPayment fields).
     */
    ...
    /**
     * Create a new CardPayment.
     *
     * @param CardPaymentCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed CardPaymentCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CardPayment|array The created CardPayment as an assoc-array at the
