...
// Nofrixion SDK OpenBanking entity
...
class OpenBankingEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new OpenBankingEntity($this->_client, $opts);
    }

    /**
     * @param OpenBanking|array $args OpenBanking data (assoc-array) to store.
     */
    ...
    /**
     * @return OpenBanking|array The current OpenBanking data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of OpenBanking fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of OpenBanking fields).
     */
     ...
     *
     * @param OpenBankingCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed OpenBankingCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return OpenBanking|array The created OpenBanking as an assoc-array at the
    ...
    /**
     * Remove an OpenBanking matching the given criteria.
     *
     * @param OpenBankingRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; OpenBankingRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return OpenBanking|array The removed OpenBanking as an assoc-array at the
     *   SDK boundary; throws NofrixionError on failure (item-5 convention).
     */
