...
class WhoamiEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new WhoamiEntity($this->_client, $opts);
    }

    /**
     * @param Whoami|array $args Whoami data (assoc-array) to store.
     */
    ...
    /**
     * @return Whoami|array The current Whoami data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Whoami fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Whoami fields).
     */
    ...
    /**
     * List Whoami items matching the given filter.
     *
     * @param WhoamiListMatch|array|null $reqmatch Match filter (any subset
     *   of Whoami fields) as an assoc-array; WhoamiListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Whoami[]|array A list of Whoami items as assoc-arrays at
