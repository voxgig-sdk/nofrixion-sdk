...
class NoFrixionVersionEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new NoFrixionVersionEntity($this->_client, $opts);
    }

    /**
     * @param NoFrixionVersion|array $args NoFrixionVersion data (assoc-array) to store.
     */
    ...
    /**
     * @return NoFrixionVersion|array The current NoFrixionVersion data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of NoFrixionVersion fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of NoFrixionVersion fields).
     */
    ...
    /**
     * Load a single NoFrixionVersion.
     *
     * @param NoFrixionVersionLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed NoFrixionVersionLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return NoFrixionVersion|array The loaded NoFrixionVersion as an assoc-array at the
