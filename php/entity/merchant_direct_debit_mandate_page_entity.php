...
class MerchantDirectDebitMandatePageEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "merchant_direct_debit_mandate_page";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new MerchantDirectDebitMandatePageEntity($this->_client, $opts);
    }

    /**
     * @param MerchantDirectDebitMandatePage|array $args MerchantDirectDebitMandatePage data (assoc-array) to store.
     */
    ...
    /**
     * @return MerchantDirectDebitMandatePage|array The current MerchantDirectDebitMandatePage data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of MerchantDirectDebitMandatePage fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of MerchantDirectDebitMandatePage fields).
     */
    ...
    /**
     * List MerchantDirectDebitMandatePage items matching the given filter.
     *
     * @param MerchantDirectDebitMandatePageListMatch|array|null $reqmatch Match filter (any subset
     *   of MerchantDirectDebitMandatePage fields) as an assoc-array; MerchantDirectDebitMandatePageListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return MerchantDirectDebitMandatePage[]|array A list of MerchantDirectDebitMandatePage items as assoc-arrays at
