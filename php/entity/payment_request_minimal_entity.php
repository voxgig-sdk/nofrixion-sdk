...
class PaymentRequestMinimalEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "payment_request_minimal";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new PaymentRequestMinimalEntity($this->_client, $opts);
    }

    /**
     * @param PaymentRequestMinimal|array $args PaymentRequestMinimal data (assoc-array) to store.
     */
    ...
    /**
     * @return PaymentRequestMinimal|array The current PaymentRequestMinimal data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of PaymentRequestMinimal fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of PaymentRequestMinimal fields).
     */
    ...
    /**
     * List PaymentRequestMinimal items matching the given filter.
     *
     * @param PaymentRequestMinimalListMatch|array|null $reqmatch Match filter (any subset
     *   of PaymentRequestMinimal fields) as an assoc-array; PaymentRequestMinimalListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PaymentRequestMinimal[]|array A list of PaymentRequestMinimal items as assoc-arrays at
