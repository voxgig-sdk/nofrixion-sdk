...
class PayeeverificationEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new PayeeverificationEntity($this->_client, $opts);
    }

    /**
     * @param Payeeverification|array $args Payeeverification data (assoc-array) to store.
     */
    ...
    /**
     * @return Payeeverification|array The current Payeeverification data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Payeeverification fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Payeeverification fields).
     */
    ...
    /**
     * Create a new Payeeverification.
     *
     * @param PayeeverificationCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed PayeeverificationCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Payeeverification|array The created Payeeverification as an assoc-array at the
