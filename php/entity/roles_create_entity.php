...
// Nofrixion SDK RolesCreate entity
...
class RolesCreateEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new RolesCreateEntity($this->_client, $opts);
    }

    /**
     * @param RolesCreate|array $args RolesCreate data (assoc-array) to store.
     */
    ...
    /**
     * @return RolesCreate|array The current RolesCreate data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of RolesCreate fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of RolesCreate fields).
     */
    ...
    /**
     * Create a new RolesCreate.
     *
     * @param RolesCreateCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed RolesCreateCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return RolesCreate|array The created RolesCreate as an assoc-array at the
