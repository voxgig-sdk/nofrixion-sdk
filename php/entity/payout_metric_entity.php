...
class PayoutMetricEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new PayoutMetricEntity($this->_client, $opts);
    }

    /**
     * @param PayoutMetric|array $args PayoutMetric data (assoc-array) to store.
     */
    ...
    /**
     * @return PayoutMetric|array The current PayoutMetric data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of PayoutMetric fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of PayoutMetric fields).
     */
    ...
    /**
     * Load a single PayoutMetric.
     *
     * @param PayoutMetricLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed PayoutMetricLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PayoutMetric|array The loaded PayoutMetric as an assoc-array at the
