...
class BeneficiaryGroupEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new BeneficiaryGroupEntity($this->_client, $opts);
    }

    /**
     * @param BeneficiaryGroup|array $args BeneficiaryGroup data (assoc-array) to store.
     */
    ...
    /**
     * @return BeneficiaryGroup|array The current BeneficiaryGroup data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of BeneficiaryGroup fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of BeneficiaryGroup fields).
     */
    ...
    /**
     * List BeneficiaryGroup items matching the given filter.
     *
     * @param BeneficiaryGroupListMatch|array|null $reqmatch Match filter (any subset
     *   of BeneficiaryGroup fields) as an assoc-array; BeneficiaryGroupListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return BeneficiaryGroup[]|array A list of BeneficiaryGroup items as assoc-arrays at
