...
// Nofrixion SDK BeneficiariesCreate entity
...
class BeneficiariesCreateEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "beneficiaries_create";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new BeneficiariesCreateEntity($this->_client, $opts);
    }

    /**
     * @param BeneficiariesCreate|array $args BeneficiariesCreate data (assoc-array) to store.
     */
    ...
    /**
     * @return BeneficiariesCreate|array The current BeneficiariesCreate data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of BeneficiariesCreate fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of BeneficiariesCreate fields).
     */
    ...
    /**
     * Create a new BeneficiariesCreate.
     *
     * @param BeneficiariesCreateCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed BeneficiariesCreateCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return BeneficiariesCreate|array The created BeneficiariesCreate as an assoc-array at the
