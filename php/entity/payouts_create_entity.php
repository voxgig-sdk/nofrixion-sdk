...
// Nofrixion SDK PayoutsCreate entity
...
class PayoutsCreateEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new PayoutsCreateEntity($this->_client, $opts);
    }

    /**
     * @param PayoutsCreate|array $args PayoutsCreate data (assoc-array) to store.
     */
    ...
    /**
     * @return PayoutsCreate|array The current PayoutsCreate data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of PayoutsCreate fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of PayoutsCreate fields).
     */
    ...
    /**
     * Create a new PayoutsCreate.
     *
     * @param PayoutsCreateCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed PayoutsCreateCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PayoutsCreate|array The created PayoutsCreate as an assoc-array at the
