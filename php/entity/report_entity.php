...
class ReportEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ReportEntity($this->_client, $opts);
    }

    /**
     * @param Report|array $args Report data (assoc-array) to store.
     */
    ...
    /**
     * @return Report|array The current Report data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Report fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Report fields).
     */
     ...
     *
     * @param ReportUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ReportUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Report|array The updated Report as an assoc-array at the
