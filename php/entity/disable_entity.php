...
class DisableEntity
{
    ...
    /**
     * Update an existing Disable.
     *
     * @param DisableUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed DisableUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Disable|array The updated Disable as an assoc-array at the
