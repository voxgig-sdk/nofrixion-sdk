...
class ReportResultEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ReportResultEntity($this->_client, $opts);
    }

    /**
     * @param ReportResult|array $args ReportResult data (assoc-array) to store.
     */
    ...
    /**
     * @return ReportResult|array The current ReportResult data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ReportResult fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ReportResult fields).
     */
    ...
    /**
     * Load a single ReportResult.
     *
     * @param ReportResultLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ReportResultLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ReportResult|array The loaded ReportResult as an assoc-array at the
