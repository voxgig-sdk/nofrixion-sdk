...
class BeneficiaryEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new BeneficiaryEntity($this->_client, $opts);
    }

    /**
     * @param Beneficiary|array $args Beneficiary data (assoc-array) to store.
     */
    ...
    /**
     * @return Beneficiary|array The current Beneficiary data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Beneficiary fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Beneficiary fields).
     */
    ...
    /**
     * Load a single Beneficiary.
     *
     * @param BeneficiaryLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed BeneficiaryLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Beneficiary|array The loaded Beneficiary as an assoc-array at the
     ...
     *
     * @param BeneficiaryCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed BeneficiaryCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Beneficiary|array The created Beneficiary as an assoc-array at the
     *   SDK boundary; throws NofrixionError on failure (item-5 convention).
     */
     ...
     *
     * @param BeneficiaryUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed BeneficiaryUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Beneficiary|array The updated Beneficiary as an assoc-array at the
     *   SDK boundary; throws NofrixionError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an Beneficiary matching the given criteria.
     *
     * @param BeneficiaryRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; BeneficiaryRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Beneficiary|array The removed Beneficiary as an assoc-array at the
     *   SDK boundary; throws NofrixionError on failure (item-5 convention).
     */
