...
class UserInviteEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new UserInviteEntity($this->_client, $opts);
    }

    /**
     * @param UserInvite|array $args UserInvite data (assoc-array) to store.
     */
    ...
    /**
     * @return UserInvite|array The current UserInvite data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of UserInvite fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of UserInvite fields).
     */
     ...
     *
     * @param UserInviteCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed UserInviteCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return UserInvite|array The created UserInvite as an assoc-array at the
     *   SDK boundary; throws NofrixionError on failure (item-5 convention).
     */
     ...
     *
     * @param UserInviteUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed UserInviteUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return UserInvite|array The updated UserInvite as an assoc-array at the
     *   SDK boundary; throws NofrixionError on failure (item-5 convention).
     */
     ...
     *
     * @param UserInviteRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; UserInviteRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return UserInvite|array The removed UserInvite as an assoc-array at the
     *   SDK boundary; throws NofrixionError on failure (item-5 convention).
     */
