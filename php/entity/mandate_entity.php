...
class MandateEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new MandateEntity($this->_client, $opts);
    }

    /**
     * @param Mandate|array $args Mandate data (assoc-array) to store.
     */
    ...
    /**
     * @return Mandate|array The current Mandate data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Mandate fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Mandate fields).
     */
    ...
    /**
     * Load a single Mandate.
     *
     * @param MandateLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed MandateLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Mandate|array The loaded Mandate as an assoc-array at the
     ...
     *
     * @param MandateCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed MandateCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Mandate|array The created Mandate as an assoc-array at the
     *   SDK boundary; throws NofrixionError on failure (item-5 convention).
     */
