...
class IPaymentEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new IPaymentEntity($this->_client, $opts);
    }

    /**
     * @param IPayment|array $args IPayment data (assoc-array) to store.
     */
    ...
    /**
     * @return IPayment|array The current IPayment data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of IPayment fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of IPayment fields).
     */
    ...
    /**
     * Create a new IPayment.
     *
     * @param IPaymentCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed IPaymentCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return IPayment|array The created IPayment as an assoc-array at the
