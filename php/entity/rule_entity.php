...
class RuleEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new RuleEntity($this->_client, $opts);
    }

    /**
     * @param Rule|array $args Rule data (assoc-array) to store.
     */
    ...
    /**
     * @return Rule|array The current Rule data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Rule fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Rule fields).
     */
     ...
     *
     * @param RuleUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed RuleUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Rule|array The updated Rule as an assoc-array at the
     *   SDK boundary; throws NofrixionError on failure (item-5 convention).
     */
     ...
     *
     * @param RuleRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; RuleRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Rule|array The removed Rule as an assoc-array at the
     *   SDK boundary; throws NofrixionError on failure (item-5 convention).
     */
