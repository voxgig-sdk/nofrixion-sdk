...
class TransactionEntity
{
     ...
     *
     * @param TransactionRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; TransactionRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Transaction|array The removed Transaction as an assoc-array at the
     *   SDK boundary; throws NofrixionError on failure (item-5 convention).
     */
