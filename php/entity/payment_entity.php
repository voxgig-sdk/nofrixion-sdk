...
class PaymentEntity
{
     ...
     *
     * @param PaymentUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed PaymentUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Payment|array The updated Payment as an assoc-array at the
     *   SDK boundary; throws NofrixionError on failure (item-5 convention).
     */
