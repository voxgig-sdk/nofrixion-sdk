...
class VirtualEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new VirtualEntity($this->_client, $opts);
    }

    /**
     * @param Virtual|array $args Virtual data (assoc-array) to store.
     */
    ...
    /**
     * @return Virtual|array The current Virtual data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Virtual fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Virtual fields).
     */
     ...
     *
     * @param VirtualCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed VirtualCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Virtual|array The created Virtual as an assoc-array at the
    ...
    /**
     * Update an existing Virtual.
     *
     * @param VirtualUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed VirtualUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Virtual|array The updated Virtual as an assoc-array at the
     *   SDK boundary; throws NofrixionError on failure (item-5 convention).
     */
