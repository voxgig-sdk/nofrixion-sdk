...
// Nofrixion SDK RuleEvent entity
...
class RuleEventEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new RuleEventEntity($this->_client, $opts);
    }

    /**
     * @param RuleEvent|array $args RuleEvent data (assoc-array) to store.
     */
    ...
    /**
     * @return RuleEvent|array The current RuleEvent data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of RuleEvent fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of RuleEvent fields).
     */
    ...
    /**
     * List RuleEvent items matching the given filter.
     *
     * @param RuleEventListMatch|array|null $reqmatch Match filter (any subset
     *   of RuleEvent fields) as an assoc-array; RuleEventListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return RuleEvent[]|array A list of RuleEvent items as assoc-arrays at
