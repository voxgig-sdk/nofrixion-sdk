...
class CardPublicKeyEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new CardPublicKeyEntity($this->_client, $opts);
    }

    /**
     * @param CardPublicKey|array $args CardPublicKey data (assoc-array) to store.
     */
    ...
    /**
     * @return CardPublicKey|array The current CardPublicKey data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of CardPublicKey fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of CardPublicKey fields).
     */
    ...
    /**
     * Load a single CardPublicKey.
     *
     * @param CardPublicKeyLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed CardPublicKeyLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CardPublicKey|array The loaded CardPublicKey as an assoc-array at the
