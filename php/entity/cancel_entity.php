...
class CancelEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new CancelEntity($this->_client, $opts);
    }

    /**
     * @param Cancel|array $args Cancel data (assoc-array) to store.
     */
    ...
    /**
     * @return Cancel|array The current Cancel data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Cancel fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Cancel fields).
     */
     ...
     *
     * @param CancelUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed CancelUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Cancel|array The updated Cancel as an assoc-array at the
