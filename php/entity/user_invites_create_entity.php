...
// Nofrixion SDK UserInvitesCreate entity
...
class UserInvitesCreateEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "user_invites_create";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new UserInvitesCreateEntity($this->_client, $opts);
    }

    /**
     * @param UserInvitesCreate|array $args UserInvitesCreate data (assoc-array) to store.
     */
    ...
    /**
     * @return UserInvitesCreate|array The current UserInvitesCreate data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of UserInvitesCreate fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of UserInvitesCreate fields).
     */
    ...
    /**
     * Create a new UserInvitesCreate.
     *
     * @param UserInvitesCreateCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed UserInvitesCreateCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return UserInvitesCreate|array The created UserInvitesCreate as an assoc-array at the
