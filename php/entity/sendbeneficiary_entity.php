...
// Nofrixion SDK Sendbeneficiary entity
...
class SendbeneficiaryEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new SendbeneficiaryEntity($this->_client, $opts);
    }

    /**
     * @param Sendbeneficiary|array $args Sendbeneficiary data (assoc-array) to store.
     */
    ...
    /**
     * @return Sendbeneficiary|array The current Sendbeneficiary data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Sendbeneficiary fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Sendbeneficiary fields).
     */
    ...
    /**
     * Create a new Sendbeneficiary.
     *
     * @param SendbeneficiaryCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed SendbeneficiaryCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Sendbeneficiary|array The created Sendbeneficiary as an assoc-array at the
