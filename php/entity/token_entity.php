...
class TokenEntity
{
     ...
     * Create a new Token.
     *
     * @param TokenCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed TokenCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Token|array The created Token as an assoc-array at the
    ...
    /**
     * Remove an Token matching the given criteria.
     *
     * @param TokenRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; TokenRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Token|array The removed Token as an assoc-array at the
     *   SDK boundary; throws NofrixionError on failure (item-5 convention).
     */
