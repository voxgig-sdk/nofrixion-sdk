...
class SendEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new SendEntity($this->_client, $opts);
    }

    /**
     * @param Send|array $args Send data (assoc-array) to store.
     */
    ...
    /**
     * @return Send|array The current Send data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Send fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Send fields).
     */
     ...
     * Create a new Send.
     *
     * @param SendCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed SendCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Send|array The created Send as an assoc-array at the
