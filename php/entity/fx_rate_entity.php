...
class FxRateEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new FxRateEntity($this->_client, $opts);
    }

    /**
     * @param FxRate|array $args FxRate data (assoc-array) to store.
     */
    ...
    /**
     * @return FxRate|array The current FxRate data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of FxRate fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of FxRate fields).
     */
    ...
    /**
     * Load a single FxRate.
     *
     * @param FxRateLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed FxRateLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return FxRate|array The loaded FxRate as an assoc-array at the
    ...
    /**
     * List FxRate items matching the given filter.
     *
     * @param FxRateListMatch|array|null $reqmatch Match filter (any subset
     *   of FxRate fields) as an assoc-array; FxRateListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return FxRate[]|array A list of FxRate items as assoc-arrays at
