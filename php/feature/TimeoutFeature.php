...
class NofrixionTimeoutFeature extends NofrixionBaseFeature
{
    ...
    private function _with_timeout(NofrixionContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(NofrixionContext $_ctx, float $ms): void
    {
        $client = $this->client;
