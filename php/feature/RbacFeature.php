...
class NofrixionRbacFeature extends NofrixionBaseFeature
{
    ...
    private function _required(NofrixionContext $ctx): ?string
    {
    ...
    private function _reject(NofrixionContext $ctx, string $required): void
    {
    ...
    private function _track(NofrixionContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
