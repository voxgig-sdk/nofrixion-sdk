...
// Nofrixion SDK streaming feature
...
class NofrixionStreamingFeature extends NofrixionBaseFeature
{
    ...
    private function _iterate(NofrixionResult $result): \Generator
    {
    ...
    private function _streamable(NofrixionContext $ctx): bool
    {
