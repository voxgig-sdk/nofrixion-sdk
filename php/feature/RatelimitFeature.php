...
// Nofrixion SDK ratelimit feature
...
class NofrixionRatelimitFeature extends NofrixionBaseFeature
{
    ...
    private function _acquire(NofrixionContext $ctx): void
    {
    ...
    private function _track(NofrixionContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
