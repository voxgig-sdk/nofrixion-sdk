...
class NofrixionCacheFeature extends NofrixionBaseFeature
{
    ...
    private function _through(NofrixionContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
