	...
	return map[string]any{
		...
		"options": map[string]any{
			...
			"entity": map[string]any{
				...
				"beneficiaries_create": map[string]any{},
				...
				"user_invites_create": map[string]any{},
