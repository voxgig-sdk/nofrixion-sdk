...
type PaymentRequestEventEntity struct {
	name    string
...
func NewPaymentRequestEventEntity(client *core.NofrixionSDK, entopts map[string]any) *PaymentRequestEventEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PaymentRequestEventEntity) GetName() string { return e.name }
...
func (e *PaymentRequestEventEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *PaymentRequestEventEntity) Deleted() bool {
	return e.deleted
}


func (e *PaymentRequestEventEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewPaymentRequestEventEntity(e.client, opts)
}

func (e *PaymentRequestEventEntity) Data(args ...any) any {
...
func (e *PaymentRequestEventEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an PaymentRequestEvent; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *PaymentRequestEventEntity) DataTyped(data ...PaymentRequestEvent) PaymentRequestEvent {
	if len(data) > 0 {
		return typedFrom[PaymentRequestEvent](e.Data(asMap(data[0])))
	}
	return typedFrom[PaymentRequestEvent](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through PaymentRequestEvent (all fields
// optional at the wire level).
func (e *PaymentRequestEventEntity) MatchTyped(match ...PaymentRequestEvent) PaymentRequestEvent {
	if len(match) > 0 {
		return typedFrom[PaymentRequestEvent](e.Match(asMap(match[0])))
	}
	return typedFrom[PaymentRequestEvent](e.Match())
}
...
func (e *PaymentRequestEventEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PaymentRequestEventEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *PaymentRequestEventEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// PaymentRequestEventListMatch and returns []PaymentRequestEvent. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *PaymentRequestEventEntity) ListTyped(reqmatch PaymentRequestEventListMatch, ctrl map[string]any) ([]PaymentRequestEvent, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[PaymentRequestEvent](res), nil
}



func (e *PaymentRequestEventEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *PaymentRequestEventEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *PaymentRequestEventEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *PaymentRequestEventEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
