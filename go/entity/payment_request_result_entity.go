...
type PaymentRequestResultEntity struct {
	name    string
...
func NewPaymentRequestResultEntity(client *core.NofrixionSDK, entopts map[string]any) *PaymentRequestResultEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PaymentRequestResultEntity) GetName() string { return e.name }
...
func (e *PaymentRequestResultEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *PaymentRequestResultEntity) Deleted() bool {
	return e.deleted
}


func (e *PaymentRequestResultEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewPaymentRequestResultEntity(e.client, opts)
}

func (e *PaymentRequestResultEntity) Data(args ...any) any {
...
func (e *PaymentRequestResultEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an PaymentRequestResult; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *PaymentRequestResultEntity) DataTyped(data ...PaymentRequestResult) PaymentRequestResult {
	if len(data) > 0 {
		return typedFrom[PaymentRequestResult](e.Data(asMap(data[0])))
	}
	return typedFrom[PaymentRequestResult](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through PaymentRequestResult (all fields
// optional at the wire level).
func (e *PaymentRequestResultEntity) MatchTyped(match ...PaymentRequestResult) PaymentRequestResult {
	if len(match) > 0 {
		return typedFrom[PaymentRequestResult](e.Match(asMap(match[0])))
	}
	return typedFrom[PaymentRequestResult](e.Match())
}
...
func (e *PaymentRequestResultEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PaymentRequestResultEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *PaymentRequestResultEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// PaymentRequestResultListMatch and returns []PaymentRequestResult. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *PaymentRequestResultEntity) ListTyped(reqmatch PaymentRequestResultListMatch, ctrl map[string]any) ([]PaymentRequestResult, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[PaymentRequestResult](res), nil
}



func (e *PaymentRequestResultEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *PaymentRequestResultEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *PaymentRequestResultEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *PaymentRequestResultEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
