...
func NewCardPaymentEntity(client *core.NofrixionSDK, entopts map[string]any) *CardPaymentEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CardPaymentEntity) GetName() string { return e.name }
...
func (e *CardPaymentEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CardPaymentEntity) Deleted() bool {
	return e.deleted
}


func (e *CardPaymentEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCardPaymentEntity(e.client, opts)
}

func (e *CardPaymentEntity) Data(args ...any) any {
...
func (e *CardPaymentEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an CardPayment; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CardPaymentEntity) DataTyped(data ...CardPayment) CardPayment {
	if len(data) > 0 {
		return typedFrom[CardPayment](e.Data(asMap(data[0])))
	}
	return typedFrom[CardPayment](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through CardPayment (all fields
// optional at the wire level).
func (e *CardPaymentEntity) MatchTyped(match ...CardPayment) CardPayment {
	if len(match) > 0 {
		return typedFrom[CardPayment](e.Match(asMap(match[0])))
	}
	return typedFrom[CardPayment](e.Match())
}
...
func (e *CardPaymentEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CardPaymentEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *CardPaymentEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *CardPaymentEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CardPaymentCreateData and returns an CardPayment. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *CardPaymentEntity) CreateTyped(reqdata CardPaymentCreateData, ctrl map[string]any) (CardPayment, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return CardPayment{}, err
	}
	return typedFrom[CardPayment](res), nil
}



func (e *CardPaymentEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CardPaymentEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CardPaymentEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
