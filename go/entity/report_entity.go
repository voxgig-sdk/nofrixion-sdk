...
func NewReportEntity(client *core.NofrixionSDK, entopts map[string]any) *ReportEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ReportEntity) GetName() string { return e.name }
...
func (e *ReportEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ReportEntity) Deleted() bool {
	return e.deleted
}


func (e *ReportEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewReportEntity(e.client, opts)
}

func (e *ReportEntity) Data(args ...any) any {
...
func (e *ReportEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Report; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ReportEntity) DataTyped(data ...Report) Report {
	if len(data) > 0 {
		return typedFrom[Report](e.Data(asMap(data[0])))
	}
	return typedFrom[Report](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Report (all fields
// optional at the wire level).
func (e *ReportEntity) MatchTyped(match ...Report) Report {
	if len(match) > 0 {
		return typedFrom[Report](e.Match(asMap(match[0])))
	}
	return typedFrom[Report](e.Match())
}
...
func (e *ReportEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ReportEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *ReportEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *ReportEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}



func (e *ReportEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ReportUpdateData and returns an Report. It delegates to the untyped
// Update (identical runtime) and converts at the typed boundary.
func (e *ReportEntity) UpdateTyped(reqdata ReportUpdateData, ctrl map[string]any) (Report, error) {
	res, err := e.Update(asMap(reqdata), ctrl)
	if err != nil {
		return Report{}, err
	}
	return typedFrom[Report](res), nil
}



func (e *ReportEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ReportEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
