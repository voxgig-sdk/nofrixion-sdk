...
type NoFrixionVersionEntity struct {
	name    string
...
func NewNoFrixionVersionEntity(client *core.NofrixionSDK, entopts map[string]any) *NoFrixionVersionEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *NoFrixionVersionEntity) GetName() string { return e.name }
...
func (e *NoFrixionVersionEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *NoFrixionVersionEntity) Deleted() bool {
	return e.deleted
}


func (e *NoFrixionVersionEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewNoFrixionVersionEntity(e.client, opts)
}

func (e *NoFrixionVersionEntity) Data(args ...any) any {
...
func (e *NoFrixionVersionEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an NoFrixionVersion; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *NoFrixionVersionEntity) DataTyped(data ...NoFrixionVersion) NoFrixionVersion {
	if len(data) > 0 {
		return typedFrom[NoFrixionVersion](e.Data(asMap(data[0])))
	}
	return typedFrom[NoFrixionVersion](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through NoFrixionVersion (all fields
// optional at the wire level).
func (e *NoFrixionVersionEntity) MatchTyped(match ...NoFrixionVersion) NoFrixionVersion {
	if len(match) > 0 {
		return typedFrom[NoFrixionVersion](e.Match(asMap(match[0])))
	}
	return typedFrom[NoFrixionVersion](e.Match())
}
...
func (e *NoFrixionVersionEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *NoFrixionVersionEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// NoFrixionVersionLoadMatch and returns an NoFrixionVersion. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *NoFrixionVersionEntity) LoadTyped(reqmatch NoFrixionVersionLoadMatch, ctrl map[string]any) (NoFrixionVersion, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return NoFrixionVersion{}, err
	}
	return typedFrom[NoFrixionVersion](res), nil
}



func (e *NoFrixionVersionEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *NoFrixionVersionEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *NoFrixionVersionEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *NoFrixionVersionEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *NoFrixionVersionEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
