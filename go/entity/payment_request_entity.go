...
type PaymentRequestEntity struct {
	name    string
...
func NewPaymentRequestEntity(client *core.NofrixionSDK, entopts map[string]any) *PaymentRequestEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PaymentRequestEntity) GetName() string { return e.name }
...
func (e *PaymentRequestEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *PaymentRequestEntity) Deleted() bool {
	return e.deleted
}


func (e *PaymentRequestEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewPaymentRequestEntity(e.client, opts)
}

func (e *PaymentRequestEntity) Data(args ...any) any {
...
func (e *PaymentRequestEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an PaymentRequest; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *PaymentRequestEntity) DataTyped(data ...PaymentRequest) PaymentRequest {
	if len(data) > 0 {
		return typedFrom[PaymentRequest](e.Data(asMap(data[0])))
	}
	return typedFrom[PaymentRequest](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through PaymentRequest (all fields
// optional at the wire level).
func (e *PaymentRequestEntity) MatchTyped(match ...PaymentRequest) PaymentRequest {
	if len(match) > 0 {
		return typedFrom[PaymentRequest](e.Match(asMap(match[0])))
	}
	return typedFrom[PaymentRequest](e.Match())
}
...
func (e *PaymentRequestEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PaymentRequestEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// PaymentRequestLoadMatch and returns an PaymentRequest. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *PaymentRequestEntity) LoadTyped(reqmatch PaymentRequestLoadMatch, ctrl map[string]any) (PaymentRequest, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return PaymentRequest{}, err
	}
	return typedFrom[PaymentRequest](res), nil
}
...
func (e *PaymentRequestEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// PaymentRequestCreateData and returns an PaymentRequest. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *PaymentRequestEntity) CreateTyped(reqdata PaymentRequestCreateData, ctrl map[string]any) (PaymentRequest, error) {
...
func (e *PaymentRequestEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "update",
		"ctrl":    ctrl,
...
// PaymentRequestUpdateData and returns an PaymentRequest. It delegates to the untyped
// Update (identical runtime) and converts at the typed boundary.
func (e *PaymentRequestEntity) UpdateTyped(reqdata PaymentRequestUpdateData, ctrl map[string]any) (PaymentRequest, error) {
...
func (e *PaymentRequestEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
// PaymentRequestRemoveMatch and returns an PaymentRequest. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *PaymentRequestEntity) RemoveTyped(reqmatch PaymentRequestRemoveMatch, ctrl map[string]any) (PaymentRequest, error) {
...
func (e *PaymentRequestEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
