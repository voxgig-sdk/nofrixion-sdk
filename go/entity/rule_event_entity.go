...
func NewRuleEventEntity(client *core.NofrixionSDK, entopts map[string]any) *RuleEventEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *RuleEventEntity) GetName() string { return e.name }
...
func (e *RuleEventEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *RuleEventEntity) Deleted() bool {
	return e.deleted
}


func (e *RuleEventEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewRuleEventEntity(e.client, opts)
}

func (e *RuleEventEntity) Data(args ...any) any {
...
func (e *RuleEventEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an RuleEvent; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *RuleEventEntity) DataTyped(data ...RuleEvent) RuleEvent {
	if len(data) > 0 {
		return typedFrom[RuleEvent](e.Data(asMap(data[0])))
	}
	return typedFrom[RuleEvent](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through RuleEvent (all fields
// optional at the wire level).
func (e *RuleEventEntity) MatchTyped(match ...RuleEvent) RuleEvent {
	if len(match) > 0 {
		return typedFrom[RuleEvent](e.Match(asMap(match[0])))
	}
	return typedFrom[RuleEvent](e.Match())
}
...
func (e *RuleEventEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *RuleEventEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *RuleEventEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// RuleEventListMatch and returns []RuleEvent. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *RuleEventEntity) ListTyped(reqmatch RuleEventListMatch, ctrl map[string]any) ([]RuleEvent, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[RuleEvent](res), nil
}



func (e *RuleEventEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *RuleEventEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *RuleEventEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *RuleEventEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
