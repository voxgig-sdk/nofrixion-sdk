...
type ReportResultEntity struct {
	name    string
...
func NewReportResultEntity(client *core.NofrixionSDK, entopts map[string]any) *ReportResultEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ReportResultEntity) GetName() string { return e.name }
...
func (e *ReportResultEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ReportResultEntity) Deleted() bool {
	return e.deleted
}


func (e *ReportResultEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewReportResultEntity(e.client, opts)
}

func (e *ReportResultEntity) Data(args ...any) any {
...
func (e *ReportResultEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an ReportResult; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ReportResultEntity) DataTyped(data ...ReportResult) ReportResult {
	if len(data) > 0 {
		return typedFrom[ReportResult](e.Data(asMap(data[0])))
	}
	return typedFrom[ReportResult](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through ReportResult (all fields
// optional at the wire level).
func (e *ReportResultEntity) MatchTyped(match ...ReportResult) ReportResult {
	if len(match) > 0 {
		return typedFrom[ReportResult](e.Match(asMap(match[0])))
	}
	return typedFrom[ReportResult](e.Match())
}
...
func (e *ReportResultEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ReportResultEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ReportResultLoadMatch and returns an ReportResult. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *ReportResultEntity) LoadTyped(reqmatch ReportResultLoadMatch, ctrl map[string]any) (ReportResult, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return ReportResult{}, err
	}
	return typedFrom[ReportResult](res), nil
}



func (e *ReportResultEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *ReportResultEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ReportResultEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ReportResultEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ReportResultEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
