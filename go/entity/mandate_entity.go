...
func NewMandateEntity(client *core.NofrixionSDK, entopts map[string]any) *MandateEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *MandateEntity) GetName() string { return e.name }
...
func (e *MandateEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *MandateEntity) Deleted() bool {
	return e.deleted
}


func (e *MandateEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewMandateEntity(e.client, opts)
}

func (e *MandateEntity) Data(args ...any) any {
...
func (e *MandateEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Mandate; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *MandateEntity) DataTyped(data ...Mandate) Mandate {
	if len(data) > 0 {
		return typedFrom[Mandate](e.Data(asMap(data[0])))
	}
	return typedFrom[Mandate](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Mandate (all fields
// optional at the wire level).
func (e *MandateEntity) MatchTyped(match ...Mandate) Mandate {
	if len(match) > 0 {
		return typedFrom[Mandate](e.Match(asMap(match[0])))
	}
	return typedFrom[Mandate](e.Match())
}
...
func (e *MandateEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *MandateEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// MandateLoadMatch and returns an Mandate. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *MandateEntity) LoadTyped(reqmatch MandateLoadMatch, ctrl map[string]any) (Mandate, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Mandate{}, err
	}
	return typedFrom[Mandate](res), nil
}



func (e *MandateEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *MandateEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// MandateCreateData and returns an Mandate. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *MandateEntity) CreateTyped(reqdata MandateCreateData, ctrl map[string]any) (Mandate, error) {
...
func (e *MandateEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *MandateEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *MandateEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
