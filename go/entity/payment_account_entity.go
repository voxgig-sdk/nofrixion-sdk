...
type PaymentAccountEntity struct {
	name    string
...
func NewPaymentAccountEntity(client *core.NofrixionSDK, entopts map[string]any) *PaymentAccountEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PaymentAccountEntity) GetName() string { return e.name }
...
func (e *PaymentAccountEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *PaymentAccountEntity) Deleted() bool {
	return e.deleted
}


func (e *PaymentAccountEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewPaymentAccountEntity(e.client, opts)
}

func (e *PaymentAccountEntity) Data(args ...any) any {
...
func (e *PaymentAccountEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an PaymentAccount; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *PaymentAccountEntity) DataTyped(data ...PaymentAccount) PaymentAccount {
	if len(data) > 0 {
		return typedFrom[PaymentAccount](e.Data(asMap(data[0])))
	}
	return typedFrom[PaymentAccount](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through PaymentAccount (all fields
// optional at the wire level).
func (e *PaymentAccountEntity) MatchTyped(match ...PaymentAccount) PaymentAccount {
	if len(match) > 0 {
		return typedFrom[PaymentAccount](e.Match(asMap(match[0])))
	}
	return typedFrom[PaymentAccount](e.Match())
}
...
func (e *PaymentAccountEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PaymentAccountEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *PaymentAccountEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// PaymentAccountListMatch and returns []PaymentAccount. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *PaymentAccountEntity) ListTyped(reqmatch PaymentAccountListMatch, ctrl map[string]any) ([]PaymentAccount, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[PaymentAccount](res), nil
}



func (e *PaymentAccountEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *PaymentAccountEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *PaymentAccountEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *PaymentAccountEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
