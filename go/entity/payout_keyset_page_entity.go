...
type PayoutKeysetPageEntity struct {
	name    string
...
func NewPayoutKeysetPageEntity(client *core.NofrixionSDK, entopts map[string]any) *PayoutKeysetPageEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PayoutKeysetPageEntity) GetName() string { return e.name }
...
func (e *PayoutKeysetPageEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *PayoutKeysetPageEntity) Deleted() bool {
	return e.deleted
}


func (e *PayoutKeysetPageEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewPayoutKeysetPageEntity(e.client, opts)
}

func (e *PayoutKeysetPageEntity) Data(args ...any) any {
...
func (e *PayoutKeysetPageEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an PayoutKeysetPage; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *PayoutKeysetPageEntity) DataTyped(data ...PayoutKeysetPage) PayoutKeysetPage {
	if len(data) > 0 {
		return typedFrom[PayoutKeysetPage](e.Data(asMap(data[0])))
	}
	return typedFrom[PayoutKeysetPage](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through PayoutKeysetPage (all fields
// optional at the wire level).
func (e *PayoutKeysetPageEntity) MatchTyped(match ...PayoutKeysetPage) PayoutKeysetPage {
	if len(match) > 0 {
		return typedFrom[PayoutKeysetPage](e.Match(asMap(match[0])))
	}
	return typedFrom[PayoutKeysetPage](e.Match())
}
...
func (e *PayoutKeysetPageEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PayoutKeysetPageEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *PayoutKeysetPageEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// PayoutKeysetPageListMatch and returns []PayoutKeysetPage. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *PayoutKeysetPageEntity) ListTyped(reqmatch PayoutKeysetPageListMatch, ctrl map[string]any) ([]PayoutKeysetPage, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[PayoutKeysetPage](res), nil
}



func (e *PayoutKeysetPageEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *PayoutKeysetPageEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *PayoutKeysetPageEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *PayoutKeysetPageEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
