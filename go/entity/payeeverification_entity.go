...
type PayeeverificationEntity struct {
	name    string
...
func NewPayeeverificationEntity(client *core.NofrixionSDK, entopts map[string]any) *PayeeverificationEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PayeeverificationEntity) GetName() string { return e.name }
...
func (e *PayeeverificationEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *PayeeverificationEntity) Deleted() bool {
	return e.deleted
}


func (e *PayeeverificationEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewPayeeverificationEntity(e.client, opts)
}

func (e *PayeeverificationEntity) Data(args ...any) any {
...
func (e *PayeeverificationEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Payeeverification; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *PayeeverificationEntity) DataTyped(data ...Payeeverification) Payeeverification {
	if len(data) > 0 {
		return typedFrom[Payeeverification](e.Data(asMap(data[0])))
	}
	return typedFrom[Payeeverification](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Payeeverification (all fields
// optional at the wire level).
func (e *PayeeverificationEntity) MatchTyped(match ...Payeeverification) Payeeverification {
	if len(match) > 0 {
		return typedFrom[Payeeverification](e.Match(asMap(match[0])))
	}
	return typedFrom[Payeeverification](e.Match())
}
...
func (e *PayeeverificationEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PayeeverificationEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *PayeeverificationEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *PayeeverificationEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// PayeeverificationCreateData and returns an Payeeverification. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *PayeeverificationEntity) CreateTyped(reqdata PayeeverificationCreateData, ctrl map[string]any) (Payeeverification, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return Payeeverification{}, err
	}
	return typedFrom[Payeeverification](res), nil
}



func (e *PayeeverificationEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *PayeeverificationEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *PayeeverificationEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
