...
type BeneficiaryGroupEntity struct {
	name    string
...
func NewBeneficiaryGroupEntity(client *core.NofrixionSDK, entopts map[string]any) *BeneficiaryGroupEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *BeneficiaryGroupEntity) GetName() string { return e.name }
...
func (e *BeneficiaryGroupEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *BeneficiaryGroupEntity) Deleted() bool {
	return e.deleted
}


func (e *BeneficiaryGroupEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewBeneficiaryGroupEntity(e.client, opts)
}

func (e *BeneficiaryGroupEntity) Data(args ...any) any {
...
func (e *BeneficiaryGroupEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an BeneficiaryGroup; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *BeneficiaryGroupEntity) DataTyped(data ...BeneficiaryGroup) BeneficiaryGroup {
	if len(data) > 0 {
		return typedFrom[BeneficiaryGroup](e.Data(asMap(data[0])))
	}
	return typedFrom[BeneficiaryGroup](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through BeneficiaryGroup (all fields
// optional at the wire level).
func (e *BeneficiaryGroupEntity) MatchTyped(match ...BeneficiaryGroup) BeneficiaryGroup {
	if len(match) > 0 {
		return typedFrom[BeneficiaryGroup](e.Match(asMap(match[0])))
	}
	return typedFrom[BeneficiaryGroup](e.Match())
}
...
func (e *BeneficiaryGroupEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *BeneficiaryGroupEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *BeneficiaryGroupEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// BeneficiaryGroupListMatch and returns []BeneficiaryGroup. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *BeneficiaryGroupEntity) ListTyped(reqmatch BeneficiaryGroupListMatch, ctrl map[string]any) ([]BeneficiaryGroup, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[BeneficiaryGroup](res), nil
}



func (e *BeneficiaryGroupEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *BeneficiaryGroupEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *BeneficiaryGroupEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *BeneficiaryGroupEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
