...
func (e *PayoutEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PayoutEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// PayoutListMatch and returns []Payout. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *PayoutEntity) ListTyped(reqmatch PayoutListMatch, ctrl map[string]any) ([]Payout, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Payout](res), nil
}
