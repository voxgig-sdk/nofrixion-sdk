...
func NewFxRateEntity(client *core.NofrixionSDK, entopts map[string]any) *FxRateEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *FxRateEntity) GetName() string { return e.name }
...
func (e *FxRateEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *FxRateEntity) Deleted() bool {
	return e.deleted
}


func (e *FxRateEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewFxRateEntity(e.client, opts)
}

func (e *FxRateEntity) Data(args ...any) any {
...
func (e *FxRateEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an FxRate; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *FxRateEntity) DataTyped(data ...FxRate) FxRate {
	if len(data) > 0 {
		return typedFrom[FxRate](e.Data(asMap(data[0])))
	}
	return typedFrom[FxRate](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through FxRate (all fields
// optional at the wire level).
func (e *FxRateEntity) MatchTyped(match ...FxRate) FxRate {
	if len(match) > 0 {
		return typedFrom[FxRate](e.Match(asMap(match[0])))
	}
	return typedFrom[FxRate](e.Match())
}
...
func (e *FxRateEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *FxRateEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// FxRateLoadMatch and returns an FxRate. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *FxRateEntity) LoadTyped(reqmatch FxRateLoadMatch, ctrl map[string]any) (FxRate, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return FxRate{}, err
	}
	return typedFrom[FxRate](res), nil
}




func (e *FxRateEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// FxRateListMatch and returns []FxRate. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *FxRateEntity) ListTyped(reqmatch FxRateListMatch, ctrl map[string]any) ([]FxRate, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[FxRate](res), nil
}



func (e *FxRateEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *FxRateEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *FxRateEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *FxRateEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
