...
type PaymentInitiationEntity struct {
	name    string
...
func NewPaymentInitiationEntity(client *core.NofrixionSDK, entopts map[string]any) *PaymentInitiationEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PaymentInitiationEntity) GetName() string { return e.name }
...
func (e *PaymentInitiationEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *PaymentInitiationEntity) Deleted() bool {
	return e.deleted
}


func (e *PaymentInitiationEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewPaymentInitiationEntity(e.client, opts)
}

func (e *PaymentInitiationEntity) Data(args ...any) any {
...
func (e *PaymentInitiationEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an PaymentInitiation; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *PaymentInitiationEntity) DataTyped(data ...PaymentInitiation) PaymentInitiation {
	if len(data) > 0 {
		return typedFrom[PaymentInitiation](e.Data(asMap(data[0])))
	}
	return typedFrom[PaymentInitiation](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through PaymentInitiation (all fields
// optional at the wire level).
func (e *PaymentInitiationEntity) MatchTyped(match ...PaymentInitiation) PaymentInitiation {
	if len(match) > 0 {
		return typedFrom[PaymentInitiation](e.Match(asMap(match[0])))
	}
	return typedFrom[PaymentInitiation](e.Match())
}
...
func (e *PaymentInitiationEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PaymentInitiationEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *PaymentInitiationEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *PaymentInitiationEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// PaymentInitiationCreateData and returns an PaymentInitiation. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *PaymentInitiationEntity) CreateTyped(reqdata PaymentInitiationCreateData, ctrl map[string]any) (PaymentInitiation, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return PaymentInitiation{}, err
	}
	return typedFrom[PaymentInitiation](res), nil
}



func (e *PaymentInitiationEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *PaymentInitiationEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *PaymentInitiationEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
