...
type CardPublicKeyEntity struct {
	name    string
...
func NewCardPublicKeyEntity(client *core.NofrixionSDK, entopts map[string]any) *CardPublicKeyEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CardPublicKeyEntity) GetName() string { return e.name }
...
func (e *CardPublicKeyEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CardPublicKeyEntity) Deleted() bool {
	return e.deleted
}


func (e *CardPublicKeyEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCardPublicKeyEntity(e.client, opts)
}

func (e *CardPublicKeyEntity) Data(args ...any) any {
...
func (e *CardPublicKeyEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an CardPublicKey; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CardPublicKeyEntity) DataTyped(data ...CardPublicKey) CardPublicKey {
	if len(data) > 0 {
		return typedFrom[CardPublicKey](e.Data(asMap(data[0])))
	}
	return typedFrom[CardPublicKey](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through CardPublicKey (all fields
// optional at the wire level).
func (e *CardPublicKeyEntity) MatchTyped(match ...CardPublicKey) CardPublicKey {
	if len(match) > 0 {
		return typedFrom[CardPublicKey](e.Match(asMap(match[0])))
	}
	return typedFrom[CardPublicKey](e.Match())
}
...
func (e *CardPublicKeyEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CardPublicKeyEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CardPublicKeyLoadMatch and returns an CardPublicKey. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *CardPublicKeyEntity) LoadTyped(reqmatch CardPublicKeyLoadMatch, ctrl map[string]any) (CardPublicKey, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return CardPublicKey{}, err
	}
	return typedFrom[CardPublicKey](res), nil
}



func (e *CardPublicKeyEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *CardPublicKeyEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *CardPublicKeyEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CardPublicKeyEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CardPublicKeyEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
