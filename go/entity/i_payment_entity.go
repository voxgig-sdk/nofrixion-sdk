...
func NewIPaymentEntity(client *core.NofrixionSDK, entopts map[string]any) *IPaymentEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *IPaymentEntity) GetName() string { return e.name }
...
func (e *IPaymentEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *IPaymentEntity) Deleted() bool {
	return e.deleted
}


func (e *IPaymentEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewIPaymentEntity(e.client, opts)
}

func (e *IPaymentEntity) Data(args ...any) any {
...
func (e *IPaymentEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an IPayment; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *IPaymentEntity) DataTyped(data ...IPayment) IPayment {
	if len(data) > 0 {
		return typedFrom[IPayment](e.Data(asMap(data[0])))
	}
	return typedFrom[IPayment](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through IPayment (all fields
// optional at the wire level).
func (e *IPaymentEntity) MatchTyped(match ...IPayment) IPayment {
	if len(match) > 0 {
		return typedFrom[IPayment](e.Match(asMap(match[0])))
	}
	return typedFrom[IPayment](e.Match())
}
...
func (e *IPaymentEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *IPaymentEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *IPaymentEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *IPaymentEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// IPaymentCreateData and returns an IPayment. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *IPaymentEntity) CreateTyped(reqdata IPaymentCreateData, ctrl map[string]any) (IPayment, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return IPayment{}, err
	}
	return typedFrom[IPayment](res), nil
}



func (e *IPaymentEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *IPaymentEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *IPaymentEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
