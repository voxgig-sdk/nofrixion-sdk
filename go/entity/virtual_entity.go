...
func NewVirtualEntity(client *core.NofrixionSDK, entopts map[string]any) *VirtualEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *VirtualEntity) GetName() string { return e.name }
...
func (e *VirtualEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *VirtualEntity) Deleted() bool {
	return e.deleted
}


func (e *VirtualEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewVirtualEntity(e.client, opts)
}

func (e *VirtualEntity) Data(args ...any) any {
...
func (e *VirtualEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Virtual; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *VirtualEntity) DataTyped(data ...Virtual) Virtual {
	if len(data) > 0 {
		return typedFrom[Virtual](e.Data(asMap(data[0])))
	}
	return typedFrom[Virtual](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Virtual (all fields
// optional at the wire level).
func (e *VirtualEntity) MatchTyped(match ...Virtual) Virtual {
	if len(match) > 0 {
		return typedFrom[Virtual](e.Match(asMap(match[0])))
	}
	return typedFrom[Virtual](e.Match())
}
...
func (e *VirtualEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *VirtualEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *VirtualEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *VirtualEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// VirtualCreateData and returns an Virtual. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *VirtualEntity) CreateTyped(reqdata VirtualCreateData, ctrl map[string]any) (Virtual, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return Virtual{}, err
	}
	return typedFrom[Virtual](res), nil
}




func (e *VirtualEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "update",
		"ctrl":    ctrl,
...
// VirtualUpdateData and returns an Virtual. It delegates to the untyped
// Update (identical runtime) and converts at the typed boundary.
func (e *VirtualEntity) UpdateTyped(reqdata VirtualUpdateData, ctrl map[string]any) (Virtual, error) {
...
func (e *VirtualEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *VirtualEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
