...
type PayoutMetricEntity struct {
	name    string
...
func NewPayoutMetricEntity(client *core.NofrixionSDK, entopts map[string]any) *PayoutMetricEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PayoutMetricEntity) GetName() string { return e.name }
...
func (e *PayoutMetricEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *PayoutMetricEntity) Deleted() bool {
	return e.deleted
}


func (e *PayoutMetricEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewPayoutMetricEntity(e.client, opts)
}

func (e *PayoutMetricEntity) Data(args ...any) any {
...
func (e *PayoutMetricEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an PayoutMetric; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *PayoutMetricEntity) DataTyped(data ...PayoutMetric) PayoutMetric {
	if len(data) > 0 {
		return typedFrom[PayoutMetric](e.Data(asMap(data[0])))
	}
	return typedFrom[PayoutMetric](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through PayoutMetric (all fields
// optional at the wire level).
func (e *PayoutMetricEntity) MatchTyped(match ...PayoutMetric) PayoutMetric {
	if len(match) > 0 {
		return typedFrom[PayoutMetric](e.Match(asMap(match[0])))
	}
	return typedFrom[PayoutMetric](e.Match())
}
...
func (e *PayoutMetricEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PayoutMetricEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// PayoutMetricLoadMatch and returns an PayoutMetric. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *PayoutMetricEntity) LoadTyped(reqmatch PayoutMetricLoadMatch, ctrl map[string]any) (PayoutMetric, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return PayoutMetric{}, err
	}
	return typedFrom[PayoutMetric](res), nil
}



func (e *PayoutMetricEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *PayoutMetricEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *PayoutMetricEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *PayoutMetricEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *PayoutMetricEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
