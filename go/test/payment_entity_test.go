...
func TestPaymentEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		paymentRef01MarkdefUp0Name := "baseOriginUrl"
		...
		paymentRef01ResdataUp0 := core.ToMapAny(entityData(paymentRef01ResdataUp0Result))
		...
		paymentRef01DataDt0LoadResult := core.ToMapAny(entityData(paymentRef01DataDt0Loaded))
...
func paymentBasicSetup(extra map[string]any) *entityTestSetup {
	...
	idmap, _ := vs.Transform(
		[]any{"payment01", "payment02", "payment03", "getbyorderid01", "getbyorderid02", "getbyorderid03", "paymentrequest01", "paymentrequest02", "paymentrequest03"},
		map[string]any{
