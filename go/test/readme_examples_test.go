...
const testSeed = `map[string]any{"entity": map[string]any{"account": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "beneficiary": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "cancel": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "disable": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "enable": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "merchant": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "metadata": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "no_frixion_biz_biz_models_paging_merchant_direct_debit_mandate_page": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "no_frixion_biz_biz_models_paging_payment_request_page": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "no_frixion_biz_biz_models_paging_payout_page": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "no_frixion_biz_biz_models_paging_payrun_page": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "no_frixion_biz_biz_models_paging_rule_events_page": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "no_frixion_biz_biz_models_paging_rules_page": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "no_frixion_biz_biz_models_payments_card_payment": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "no_frixion_biz_biz_models_payments_card_public_key": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "no_frixion_money_moov_api_features_beneficiaries_beneficiaries": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "no_frixion_money_moov_api_features_payment_requests_payment": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "no_frixion_money_moov_api_features_permissions_roles_create": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "no_frixion_money_moov_api_features_user_invites_create": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "no_frixion_money_moov_models_authorisation_settings_merchant": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "no_frixion_money_moov_models_batch_payout": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "no_frixion_money_moov_models_beneficiary_group_page": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "no_frixion_money_moov_models_beneficiary_page": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "no_frixion_money_moov_models_card_customer_token": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "no_frixion_money_moov_models_currency_currency_info": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "no_frixion_money_moov_models_direct_debit_batch_submit": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "no_frixion_money_moov_models_fx_rate": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "no_frixion_money_moov_models_i_payment": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "no_frixion_money_moov_models_mandates_mandate": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "no_frixion_money_moov_models_merchant": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "no_frixion_money_moov_models_merchant_page": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "no_frixion_money_moov_models_merchant_pay_by_bank_setting": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "no_frixion_money_moov_models_merchant_token": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "no_frixion_money_moov_models_merchant_token_page": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "no_frixion_money_moov_models_no_frixion_version": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "no_frixion_money_moov_models_open_banking_account": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "no_frixion_money_moov_models_open_banking_consent": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "no_frixion_money_moov_models_open_banking_transaction": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "no_frixion_money_moov_models_payment": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "no_frixion_money_moov_models_payment_account_minimal_page": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "no_frixion_money_moov_models_payment_account_page": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "no_frixion_money_moov_models_payment_initiation": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "no_frixion_money_moov_models_payment_request_event": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "no_frixion_money_moov_models_payment_request_metric": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "no_frixion_money_moov_models_payment_request_minimal": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "no_frixion_money_moov_models_payment_request_result": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "no_frixion_money_moov_models_payment_requests_merchant_payment": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "no_frixion_money_moov_models_payment_requests_merchant_payment2": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "no_frixion_money_moov_models_payment_requests_merchant_payment3": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "no_frixion_money_moov_models_payment_requests_merchant_payment4": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "no_frixion_money_moov_models_payout_keyset_page": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "no_frixion_money_moov_models_payout_metric": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "no_frixion_money_moov_models_payouts_payouts_create": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "no_frixion_money_moov_models_payrun": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "no_frixion_money_moov_models_report_result": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "no_frixion_money_moov_models_rule": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "no_frixion_money_moov_models_transaction": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "no_frixion_money_moov_models_transaction_page": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "no_frixion_money_moov_models_user_invite": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "no_frixion_money_moov_models_user_invite_page": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "no_frixion_money_moov_models_user_page": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "no_frixion_money_moov_models_webhook": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "open_banking": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "payeeverification": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "payment_request": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "payout": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "payrun": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "reject": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "report": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "rule": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "send": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "sendbeneficiary": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "tag": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "token": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "transaction": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "user": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "user_invite": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "virtual": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "webhook": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "whoami": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "whoamitrustedapp": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
