...
const testSeed = `map[string]any{"entity": map[string]any{"account": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "batch": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "beneficiaries_create": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "beneficiary": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "beneficiary_group": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "card": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "card_customer_token": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "card_payment": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "card_public_key": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "consent": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "currency": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "direct_debit_batch_submit": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "fx_rate": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "i_payment": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "mandate": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "merchant": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "merchant_authorisation_setting": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "merchant_direct_debit_mandate": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "merchant_pay_by_bank_setting": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "merchant_payment_request_template": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "merchant_token": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "metadata": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "no_frixion_version": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "open_banking": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "payeeverification": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "payment": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "payment_account": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "payment_account_minimal": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "payment_initiation": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "payment_request": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "payment_request_event": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "payment_request_metric": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "payment_request_minimal": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "payment_request_result": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "payment_requests_create": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "payout": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "payout_keyset": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "payout_metric": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "payouts_create": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "payrun": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "report": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "report_result": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "roles_create": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "rule": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "rule_event": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "tag": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "token": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "transaction": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "user": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "user_invite": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "user_invites_create": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "virtual": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "webhook": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
