...
func TestCardCustomerTokenEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		cardCustomerTokenRef01DataRaw := vs.Items(core.ToMapAny(vs.GetPath(setup.data, "existing.card_customer_token")))
		...
		cardCustomerTokenRef01DataDt0LoadResult := core.ToMapAny(entityData(cardCustomerTokenRef01DataDt0Loaded))
