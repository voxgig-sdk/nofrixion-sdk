...
module NofrixionTestRunner
  ...
  def self.env_override(m)
    live = getenv("NOFRIXION_TEST_LIVE")
    override = getenv("NOFRIXION_TEST_OVERRIDE")
    ...
    explain = getenv("NOFRIXION_TEST_EXPLAIN")
    m["NOFRIXION_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = NofrixionTestRunner
Helpers = NofrixionHelpers
Vs = VoxgigStruct
