...
class TokenEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set NOFRIXION_TEST_TOKEN_ENTID JSON to run live"
      return
    end
    client = setup[:client]

    # CREATE
    token_ref01_ent = client.Token(nil)
...
def token_basic_setup(extra)
  ...
  entid_env_raw = ENV["NOFRIXION_TEST_TOKEN_ENTID"]
