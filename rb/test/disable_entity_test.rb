...
class DisableEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set NOFRIXION_TEST_DISABLE_ENTID JSON to run live"
      return
    end
    client = setup[:client]
    ...
    # UPDATE
    disable_ref01_ent = client.Disable(nil)
    ...
    assert_equal disable_ref01_resdata_up0["id"], disable_ref01_data_up0_up["id"]
    assert_equal disable_ref01_resdata_up0[disable_ref01_markdef_up0_name], disable_ref01_markdef_up0_value
...
def disable_basic_setup(extra)
  ...
  entid_env_raw = ENV["NOFRIXION_TEST_DISABLE_ENTID"]
