...
class PrimaryUtilityTest < Minitest::Test
  ...
  def setup
    @runner = NofrixionOmni.make_runner(TEST_JSON_FILE, NofrixionSDK.test(nil, nil))
  ...
  def test_make_point_basic
    ...
    subject = lambda do |ctx|
      ...
      err.nil? ? point : NofrixionOmni.errify(err)
    end
