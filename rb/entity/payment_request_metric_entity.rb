...
class PaymentRequestMetricEntity
  ...
  def make
    opts = @_entopts.dup
    PaymentRequestMetricEntity.new(@_client, opts)
  end
  ...
  # @return [PaymentRequestMetric, Hash] the current PaymentRequestMetric data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of PaymentRequestMetric fields)
  def match_get
  ...
  #
  # @param reqmatch [PaymentRequestMetricLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.PaymentRequestMetric.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [PaymentRequestMetric, Hash] the loaded PaymentRequestMetric; raises NofrixionError on failure
