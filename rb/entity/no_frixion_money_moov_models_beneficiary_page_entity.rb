...
class NoFrixionMoneyMoovModelsBeneficiaryPageEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "no_frixion_money_moov_models_beneficiary_page"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    NoFrixionMoneyMoovModelsBeneficiaryPageEntity.new(@_client, opts)
  end
  ...
  # @return [NoFrixionMoneyMoovModelsBeneficiaryPage, Hash] the current NoFrixionMoneyMoovModelsBeneficiaryPage data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of NoFrixionMoneyMoovModelsBeneficiaryPage fields)
  def match_get
  ...
  #
  # @param reqmatch [NoFrixionMoneyMoovModelsBeneficiaryPageListMatch, Hash, nil] match filter (any subset of
  #   NoFrixionMoneyMoovModelsBeneficiaryPage fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<NoFrixionMoneyMoovModelsBeneficiaryPage>, Array] the matching NoFrixionMoneyMoovModelsBeneficiaryPage items; raises NofrixionError on failure
