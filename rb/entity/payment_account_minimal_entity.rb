...
class PaymentAccountMinimalEntity
  ...
  def make
    opts = @_entopts.dup
    PaymentAccountMinimalEntity.new(@_client, opts)
  end
  ...
  # @return [PaymentAccountMinimal, Hash] the current PaymentAccountMinimal data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of PaymentAccountMinimal fields)
  def match_get
  ...
  #
  # @param reqmatch [PaymentAccountMinimalListMatch, Hash, nil] match filter (any subset of
  #   PaymentAccountMinimal fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<PaymentAccountMinimal>, Array] the matching PaymentAccountMinimal items; raises NofrixionError on failure
