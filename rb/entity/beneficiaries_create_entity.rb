...
class BeneficiariesCreateEntity
  ...
  def make
    opts = @_entopts.dup
    BeneficiariesCreateEntity.new(@_client, opts)
  end
  ...
  # @return [BeneficiariesCreate, Hash] the current BeneficiariesCreate data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of BeneficiariesCreate fields)
  def match_get
  ...
  #
  # @param reqdata [BeneficiariesCreateCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [BeneficiariesCreate, Hash] the created BeneficiariesCreate; raises NofrixionError on failure
