...
class BeneficiaryEntity
  ...
  def make
    opts = @_entopts.dup
    BeneficiaryEntity.new(@_client, opts)
  end
  ...
  # @return [Beneficiary, Hash] the current Beneficiary data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Beneficiary fields)
  def match_get
  ...
  #
  # @param reqmatch [BeneficiaryLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Beneficiary.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Beneficiary, Hash] the loaded Beneficiary; raises NofrixionError on failure
  ...
  #
  # @param reqmatch [BeneficiaryListMatch, Hash, nil] match filter (any subset of
  #   Beneficiary fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Beneficiary>, Array] the matching Beneficiary items; raises NofrixionError on failure
  ...
  #
  # @param reqdata [BeneficiaryCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Beneficiary, Hash] the created Beneficiary; raises NofrixionError on failure
  ...
  #
  # @param reqdata [BeneficiaryUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Beneficiary, Hash] the updated Beneficiary; raises NofrixionError on failure
  ...
  #
  # @param reqmatch [BeneficiaryRemoveMatch, Hash, nil] match criteria (id/query fields)
  # @param ctrl [Object, nil] optional per-call control
  # @return [Beneficiary, Hash] the removed Beneficiary; raises NofrixionError on failure
