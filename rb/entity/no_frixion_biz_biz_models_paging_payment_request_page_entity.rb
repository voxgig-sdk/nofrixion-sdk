...
class NoFrixionBizBizModelsPagingPaymentRequestPageEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "no_frixion_biz_biz_models_paging_payment_request_page"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    NoFrixionBizBizModelsPagingPaymentRequestPageEntity.new(@_client, opts)
  end
  ...
  # @return [NoFrixionBizBizModelsPagingPaymentRequestPage, Hash] the current NoFrixionBizBizModelsPagingPaymentRequestPage data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of NoFrixionBizBizModelsPagingPaymentRequestPage fields)
  def match_get
  ...
  #
  # @param reqmatch [NoFrixionBizBizModelsPagingPaymentRequestPageListMatch, Hash, nil] match filter (any subset of
  #   NoFrixionBizBizModelsPagingPaymentRequestPage fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<NoFrixionBizBizModelsPagingPaymentRequestPage>, Array] the matching NoFrixionBizBizModelsPagingPaymentRequestPage items; raises NofrixionError on failure
