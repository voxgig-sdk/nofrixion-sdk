...
class NoFrixionMoneyMoovModelsCurrencyCurrencyInfoEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "no_frixion_money_moov_models_currency_currency_info"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    NoFrixionMoneyMoovModelsCurrencyCurrencyInfoEntity.new(@_client, opts)
  end
  ...
  # @return [NoFrixionMoneyMoovModelsCurrencyCurrencyInfo, Hash] the current NoFrixionMoneyMoovModelsCurrencyCurrencyInfo data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of NoFrixionMoneyMoovModelsCurrencyCurrencyInfo fields)
  def match_get
  ...
  #
  # @param reqmatch [NoFrixionMoneyMoovModelsCurrencyCurrencyInfoListMatch, Hash, nil] match filter (any subset of
  #   NoFrixionMoneyMoovModelsCurrencyCurrencyInfo fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<NoFrixionMoneyMoovModelsCurrencyCurrencyInfo>, Array] the matching NoFrixionMoneyMoovModelsCurrencyCurrencyInfo items; raises NofrixionError on failure
