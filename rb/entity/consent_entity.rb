...
class ConsentEntity
  ...
  def make
    opts = @_entopts.dup
    ConsentEntity.new(@_client, opts)
  end
  ...
  # @return [Consent, Hash] the current Consent data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Consent fields)
  def match_get
  ...
  #
  # @param reqmatch [ConsentLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Consent.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Consent, Hash] the loaded Consent; raises NofrixionError on failure
  ...
  #
  # @param reqmatch [ConsentListMatch, Hash, nil] match filter (any subset of
  #   Consent fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Consent>, Array] the matching Consent items; raises NofrixionError on failure
  ...
  #
  # @param reqdata [ConsentCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Consent, Hash] the created Consent; raises NofrixionError on failure
  ...
  #
  # @param reqdata [ConsentUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Consent, Hash] the updated Consent; raises NofrixionError on failure
  ...
  #
  # @param reqmatch [ConsentRemoveMatch, Hash, nil] match criteria (id/query fields)
  # @param ctrl [Object, nil] optional per-call control
  # @return [Consent, Hash] the removed Consent; raises NofrixionError on failure
