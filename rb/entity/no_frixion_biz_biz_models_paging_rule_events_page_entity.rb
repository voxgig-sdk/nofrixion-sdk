...
class NoFrixionBizBizModelsPagingRuleEventsPageEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "no_frixion_biz_biz_models_paging_rule_events_page"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    NoFrixionBizBizModelsPagingRuleEventsPageEntity.new(@_client, opts)
  end
  ...
  # @return [NoFrixionBizBizModelsPagingRuleEventsPage, Hash] the current NoFrixionBizBizModelsPagingRuleEventsPage data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of NoFrixionBizBizModelsPagingRuleEventsPage fields)
  def match_get
  ...
  #
  # @param reqmatch [NoFrixionBizBizModelsPagingRuleEventsPageListMatch, Hash, nil] match filter (any subset of
  #   NoFrixionBizBizModelsPagingRuleEventsPage fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<NoFrixionBizBizModelsPagingRuleEventsPage>, Array] the matching NoFrixionBizBizModelsPagingRuleEventsPage items; raises NofrixionError on failure
