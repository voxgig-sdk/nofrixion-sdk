...
class NoFrixionMoneyMoovModelsTransactionEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "no_frixion_money_moov_models_transaction"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    NoFrixionMoneyMoovModelsTransactionEntity.new(@_client, opts)
  end
  ...
  # @return [NoFrixionMoneyMoovModelsTransaction, Hash] the current NoFrixionMoneyMoovModelsTransaction data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of NoFrixionMoneyMoovModelsTransaction fields)
  def match_get
  ...
  #
  # @param reqmatch [NoFrixionMoneyMoovModelsTransactionLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.NoFrixionMoneyMoovModelsTransaction.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [NoFrixionMoneyMoovModelsTransaction, Hash] the loaded NoFrixionMoneyMoovModelsTransaction; raises NofrixionError on failure
