...
class NoFrixionMoneyMoovModelsPaymentRequestsMerchantPaymentEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "no_frixion_money_moov_models_payment_requests_merchant_payment"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    NoFrixionMoneyMoovModelsPaymentRequestsMerchantPaymentEntity.new(@_client, opts)
  end
  ...
  # @return [NoFrixionMoneyMoovModelsPaymentRequestsMerchantPayment, Hash] the current NoFrixionMoneyMoovModelsPaymentRequestsMerchantPayment data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of NoFrixionMoneyMoovModelsPaymentRequestsMerchantPayment fields)
  def match_get
  ...
  #
  # @param reqmatch [NoFrixionMoneyMoovModelsPaymentRequestsMerchantPaymentListMatch, Hash, nil] match filter (any subset of
  #   NoFrixionMoneyMoovModelsPaymentRequestsMerchantPayment fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<NoFrixionMoneyMoovModelsPaymentRequestsMerchantPayment>, Array] the matching NoFrixionMoneyMoovModelsPaymentRequestsMerchantPayment items; raises NofrixionError on failure
