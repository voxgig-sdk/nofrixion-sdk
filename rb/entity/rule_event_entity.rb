...
class RuleEventEntity
  ...
  def make
    opts = @_entopts.dup
    RuleEventEntity.new(@_client, opts)
  end
  ...
  # @return [RuleEvent, Hash] the current RuleEvent data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of RuleEvent fields)
  def match_get
  ...
  #
  # @param reqmatch [RuleEventListMatch, Hash, nil] match filter (any subset of
  #   RuleEvent fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<RuleEvent>, Array] the matching RuleEvent items; raises NofrixionError on failure
