...
class PayoutKeysetEntity
  ...
  def make
    opts = @_entopts.dup
    PayoutKeysetEntity.new(@_client, opts)
  end
  ...
  # @return [PayoutKeyset, Hash] the current PayoutKeyset data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of PayoutKeyset fields)
  def match_get
  ...
  #
  # @param reqmatch [PayoutKeysetListMatch, Hash, nil] match filter (any subset of
  #   PayoutKeyset fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<PayoutKeyset>, Array] the matching PayoutKeyset items; raises NofrixionError on failure
