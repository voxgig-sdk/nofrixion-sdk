...
class SendEntity
  ...
  # @return [Send, Hash] the current Send data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Send fields)
  def match_get
  ...
  # Create a new Send.
  #
  # @param reqdata [SendCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Send, Hash] the created Send; raises NofrixionError on failure
