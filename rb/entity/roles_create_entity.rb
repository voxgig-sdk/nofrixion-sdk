...
class RolesCreateEntity
  ...
  def make
    opts = @_entopts.dup
    RolesCreateEntity.new(@_client, opts)
  end
  ...
  # @return [RolesCreate, Hash] the current RolesCreate data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of RolesCreate fields)
  def match_get
  ...
  #
  # @param reqdata [RolesCreateCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [RolesCreate, Hash] the created RolesCreate; raises NofrixionError on failure
