...
class PayrunEntity
  ...
  # @return [Payrun, Hash] the current Payrun data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Payrun fields)
  def match_get
  ...
  # Create a new Payrun.
  #
  # @param reqdata [PayrunCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Payrun, Hash] the created Payrun; raises NofrixionError on failure
  ...
  #
  # @param reqdata [PayrunUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Payrun, Hash] the updated Payrun; raises NofrixionError on failure
  ...
  #
  # @param reqmatch [PayrunRemoveMatch, Hash, nil] match criteria (id/query fields)
  # @param ctrl [Object, nil] optional per-call control
  # @return [Payrun, Hash] the removed Payrun; raises NofrixionError on failure
