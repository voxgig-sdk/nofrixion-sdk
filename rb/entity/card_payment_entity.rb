...
class CardPaymentEntity
  ...
  def make
    opts = @_entopts.dup
    CardPaymentEntity.new(@_client, opts)
  end
  ...
  # @return [CardPayment, Hash] the current CardPayment data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of CardPayment fields)
  def match_get
  ...
  #
  # @param reqdata [CardPaymentCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [CardPayment, Hash] the created CardPayment; raises NofrixionError on failure
