...
class NoFrixionMoneyMoovModelsPayoutKeysetPageEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "no_frixion_money_moov_models_payout_keyset_page"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    NoFrixionMoneyMoovModelsPayoutKeysetPageEntity.new(@_client, opts)
  end
  ...
  # @return [NoFrixionMoneyMoovModelsPayoutKeysetPage, Hash] the current NoFrixionMoneyMoovModelsPayoutKeysetPage data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of NoFrixionMoneyMoovModelsPayoutKeysetPage fields)
  def match_get
  ...
  #
  # @param reqmatch [NoFrixionMoneyMoovModelsPayoutKeysetPageListMatch, Hash, nil] match filter (any subset of
  #   NoFrixionMoneyMoovModelsPayoutKeysetPage fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<NoFrixionMoneyMoovModelsPayoutKeysetPage>, Array] the matching NoFrixionMoneyMoovModelsPayoutKeysetPage items; raises NofrixionError on failure
