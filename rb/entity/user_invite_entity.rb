# Nofrixion SDK UserInvite entity
...
class UserInviteEntity
  ...
  def make
    opts = @_entopts.dup
    UserInviteEntity.new(@_client, opts)
  end
  ...
  # @return [UserInvite, Hash] the current UserInvite data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of UserInvite fields)
  def match_get
  ...
  #
  # @param reqmatch [UserInviteLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.UserInvite.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [UserInvite, Hash] the loaded UserInvite; raises NofrixionError on failure
  ...
  #
  # @param reqmatch [UserInviteListMatch, Hash, nil] match filter (any subset of
  #   UserInvite fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<UserInvite>, Array] the matching UserInvite items; raises NofrixionError on failure
  ...
  # Create a new UserInvite.
  #
  # @param reqdata [UserInviteCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [UserInvite, Hash] the created UserInvite; raises NofrixionError on failure
  ...
  # Update an existing UserInvite.
  #
  # @param reqdata [UserInviteUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [UserInvite, Hash] the updated UserInvite; raises NofrixionError on failure
  ...
  # Remove an UserInvite matching the given criteria.
  #
  # @param reqmatch [UserInviteRemoveMatch, Hash, nil] match criteria (id/query fields)
  # @param ctrl [Object, nil] optional per-call control
  # @return [UserInvite, Hash] the removed UserInvite; raises NofrixionError on failure
