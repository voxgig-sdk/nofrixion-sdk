...
class NoFrixionMoneyMoovModelsPaymentAccountMinimalPageEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "no_frixion_money_moov_models_payment_account_minimal_page"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    NoFrixionMoneyMoovModelsPaymentAccountMinimalPageEntity.new(@_client, opts)
  end
  ...
  # @return [NoFrixionMoneyMoovModelsPaymentAccountMinimalPage, Hash] the current NoFrixionMoneyMoovModelsPaymentAccountMinimalPage data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of NoFrixionMoneyMoovModelsPaymentAccountMinimalPage fields)
  def match_get
  ...
  #
  # @param reqmatch [NoFrixionMoneyMoovModelsPaymentAccountMinimalPageListMatch, Hash, nil] match filter (any subset of
  #   NoFrixionMoneyMoovModelsPaymentAccountMinimalPage fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<NoFrixionMoneyMoovModelsPaymentAccountMinimalPage>, Array] the matching NoFrixionMoneyMoovModelsPaymentAccountMinimalPage items; raises NofrixionError on failure
