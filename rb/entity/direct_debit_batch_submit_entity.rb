...
class DirectDebitBatchSubmitEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "direct_debit_batch_submit"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    DirectDebitBatchSubmitEntity.new(@_client, opts)
  end
  ...
  # @return [DirectDebitBatchSubmit, Hash] the current DirectDebitBatchSubmit data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of DirectDebitBatchSubmit fields)
  def match_get
  ...
  #
  # @param reqdata [DirectDebitBatchSubmitCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [DirectDebitBatchSubmit, Hash] the created DirectDebitBatchSubmit; raises NofrixionError on failure
