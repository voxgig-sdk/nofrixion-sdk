...
class PayoutEntity
  ...
  # @return [Payout, Hash] the current Payout data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Payout fields)
  def match_get
  ...
  #
  # @param reqmatch [PayoutLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Payout.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Payout, Hash] the loaded Payout; raises NofrixionError on failure
  ...
  #
  # @param reqmatch [PayoutListMatch, Hash, nil] match filter (any subset of
  #   Payout fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Payout>, Array] the matching Payout items; raises NofrixionError on failure
  ...
  # Create a new Payout.
  #
  # @param reqdata [PayoutCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Payout, Hash] the created Payout; raises NofrixionError on failure
  ...
  #
  # @param reqdata [PayoutUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Payout, Hash] the updated Payout; raises NofrixionError on failure
  ...
  #
  # @param reqmatch [PayoutRemoveMatch, Hash, nil] match criteria (id/query fields)
  # @param ctrl [Object, nil] optional per-call control
  # @return [Payout, Hash] the removed Payout; raises NofrixionError on failure
