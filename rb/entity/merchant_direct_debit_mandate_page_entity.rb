...
class MerchantDirectDebitMandatePageEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "merchant_direct_debit_mandate_page"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    MerchantDirectDebitMandatePageEntity.new(@_client, opts)
  end
  ...
  # @return [MerchantDirectDebitMandatePage, Hash] the current MerchantDirectDebitMandatePage data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of MerchantDirectDebitMandatePage fields)
  def match_get
  ...
  #
  # @param reqmatch [MerchantDirectDebitMandatePageListMatch, Hash, nil] match filter (any subset of
  #   MerchantDirectDebitMandatePage fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<MerchantDirectDebitMandatePage>, Array] the matching MerchantDirectDebitMandatePage items; raises NofrixionError on failure
