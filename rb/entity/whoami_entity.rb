...
class WhoamiEntity
  ...
  # @return [Whoami, Hash] the current Whoami data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Whoami fields)
  def match_get
  ...
  #
  # @param reqmatch [WhoamiListMatch, Hash, nil] match filter (any subset of
  #   Whoami fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Whoami>, Array] the matching Whoami items; raises NofrixionError on failure
