...
class MerchantPayByBankSettingEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "merchant_pay_by_bank_setting"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    MerchantPayByBankSettingEntity.new(@_client, opts)
  end
  ...
  # @return [MerchantPayByBankSetting, Hash] the current MerchantPayByBankSetting data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of MerchantPayByBankSetting fields)
  def match_get
  ...
  #
  # @param reqmatch [MerchantPayByBankSettingListMatch, Hash, nil] match filter (any subset of
  #   MerchantPayByBankSetting fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<MerchantPayByBankSetting>, Array] the matching MerchantPayByBankSetting items; raises NofrixionError on failure
