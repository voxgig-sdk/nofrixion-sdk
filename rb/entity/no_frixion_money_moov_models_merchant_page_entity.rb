...
class NoFrixionMoneyMoovModelsMerchantPageEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "no_frixion_money_moov_models_merchant_page"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    NoFrixionMoneyMoovModelsMerchantPageEntity.new(@_client, opts)
  end
  ...
  # @return [NoFrixionMoneyMoovModelsMerchantPage, Hash] the current NoFrixionMoneyMoovModelsMerchantPage data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of NoFrixionMoneyMoovModelsMerchantPage fields)
  def match_get
  ...
  #
  # @param reqmatch [NoFrixionMoneyMoovModelsMerchantPageListMatch, Hash, nil] match filter (any subset of
  #   NoFrixionMoneyMoovModelsMerchantPage fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<NoFrixionMoneyMoovModelsMerchantPage>, Array] the matching NoFrixionMoneyMoovModelsMerchantPage items; raises NofrixionError on failure
