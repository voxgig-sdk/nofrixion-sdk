...
class NoFrixionBizBizModelsPaymentsCardPaymentEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "no_frixion_biz_biz_models_payments_card_payment"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    NoFrixionBizBizModelsPaymentsCardPaymentEntity.new(@_client, opts)
  end
  ...
  # @return [NoFrixionBizBizModelsPaymentsCardPayment, Hash] the current NoFrixionBizBizModelsPaymentsCardPayment data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of NoFrixionBizBizModelsPaymentsCardPayment fields)
  def match_get
  ...
  #
  # @param reqdata [NoFrixionBizBizModelsPaymentsCardPaymentCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [NoFrixionBizBizModelsPaymentsCardPayment, Hash] the created NoFrixionBizBizModelsPaymentsCardPayment; raises NofrixionError on failure
