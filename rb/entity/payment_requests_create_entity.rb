...
class PaymentRequestsCreateEntity
  ...
  def make
    opts = @_entopts.dup
    PaymentRequestsCreateEntity.new(@_client, opts)
  end
  ...
  # @return [PaymentRequestsCreate, Hash] the current PaymentRequestsCreate data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of PaymentRequestsCreate fields)
  def match_get
  ...
  #
  # @param reqdata [PaymentRequestsCreateCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [PaymentRequestsCreate, Hash] the created PaymentRequestsCreate; raises NofrixionError on failure
