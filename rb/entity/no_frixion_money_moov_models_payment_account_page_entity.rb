...
class NoFrixionMoneyMoovModelsPaymentAccountPageEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "no_frixion_money_moov_models_payment_account_page"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    NoFrixionMoneyMoovModelsPaymentAccountPageEntity.new(@_client, opts)
  end
  ...
  # @return [NoFrixionMoneyMoovModelsPaymentAccountPage, Hash] the current NoFrixionMoneyMoovModelsPaymentAccountPage data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of NoFrixionMoneyMoovModelsPaymentAccountPage fields)
  def match_get
  ...
  #
  # @param reqmatch [NoFrixionMoneyMoovModelsPaymentAccountPageListMatch, Hash, nil] match filter (any subset of
  #   NoFrixionMoneyMoovModelsPaymentAccountPage fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<NoFrixionMoneyMoovModelsPaymentAccountPage>, Array] the matching NoFrixionMoneyMoovModelsPaymentAccountPage items; raises NofrixionError on failure
