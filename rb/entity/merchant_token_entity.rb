...
class MerchantTokenEntity
  ...
  def make
    opts = @_entopts.dup
    MerchantTokenEntity.new(@_client, opts)
  end
  ...
  # @return [MerchantToken, Hash] the current MerchantToken data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of MerchantToken fields)
  def match_get
  ...
  #
  # @param reqmatch [MerchantTokenLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.MerchantToken.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [MerchantToken, Hash] the loaded MerchantToken; raises NofrixionError on failure
  ...
  #
  # @param reqmatch [MerchantTokenListMatch, Hash, nil] match filter (any subset of
  #   MerchantToken fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<MerchantToken>, Array] the matching MerchantToken items; raises NofrixionError on failure
  ...
  #
  # @param reqdata [MerchantTokenCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [MerchantToken, Hash] the created MerchantToken; raises NofrixionError on failure
  ...
  #
  # @param reqdata [MerchantTokenUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [MerchantToken, Hash] the updated MerchantToken; raises NofrixionError on failure
