...
class PayeeverificationEntity
  ...
  def make
    opts = @_entopts.dup
    PayeeverificationEntity.new(@_client, opts)
  end
  ...
  # @return [Payeeverification, Hash] the current Payeeverification data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Payeeverification fields)
  def match_get
  ...
  #
  # @param reqdata [PayeeverificationCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Payeeverification, Hash] the created Payeeverification; raises NofrixionError on failure
