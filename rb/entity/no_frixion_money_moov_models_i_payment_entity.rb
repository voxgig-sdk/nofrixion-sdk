...
class NoFrixionMoneyMoovModelsIPaymentEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "no_frixion_money_moov_models_i_payment"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    NoFrixionMoneyMoovModelsIPaymentEntity.new(@_client, opts)
  end
  ...
  # @return [NoFrixionMoneyMoovModelsIPayment, Hash] the current NoFrixionMoneyMoovModelsIPayment data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of NoFrixionMoneyMoovModelsIPayment fields)
  def match_get
  ...
  #
  # @param reqdata [NoFrixionMoneyMoovModelsIPaymentCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [NoFrixionMoneyMoovModelsIPayment, Hash] the created NoFrixionMoneyMoovModelsIPayment; raises NofrixionError on failure
