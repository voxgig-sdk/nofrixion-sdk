...
class SendbeneficiaryEntity
  ...
  def make
    opts = @_entopts.dup
    SendbeneficiaryEntity.new(@_client, opts)
  end
  ...
  # @return [Sendbeneficiary, Hash] the current Sendbeneficiary data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Sendbeneficiary fields)
  def match_get
  ...
  #
  # @param reqdata [SendbeneficiaryCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Sendbeneficiary, Hash] the created Sendbeneficiary; raises NofrixionError on failure
