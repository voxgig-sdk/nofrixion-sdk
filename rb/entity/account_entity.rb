...
class AccountEntity
  ...
  # @return [Account, Hash] the loaded Account; raises NofrixionError on failure
  ...
  #
  # @param reqmatch [AccountListMatch, Hash, nil] match filter (any subset of
  #   Account fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Account>, Array] the matching Account items; raises NofrixionError on failure
  ...
  #
  # @param reqdata [AccountCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Account, Hash] the created Account; raises NofrixionError on failure
  ...
  #
  # @param reqdata [AccountUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Account, Hash] the updated Account; raises NofrixionError on failure
  ...
  #
  # @param reqmatch [AccountRemoveMatch, Hash, nil] match criteria (id/query fields)
  # @param ctrl [Object, nil] optional per-call control
  # @return [Account, Hash] the removed Account; raises NofrixionError on failure
