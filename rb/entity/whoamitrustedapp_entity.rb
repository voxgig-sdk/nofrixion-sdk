...
class WhoamitrustedappEntity
  ...
  def make
    opts = @_entopts.dup
    WhoamitrustedappEntity.new(@_client, opts)
  end
  ...
  # @return [Whoamitrustedapp, Hash] the current Whoamitrustedapp data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Whoamitrustedapp fields)
  def match_get
  ...
  #
  # @param reqmatch [WhoamitrustedappListMatch, Hash, nil] match filter (any subset of
  #   Whoamitrustedapp fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Whoamitrustedapp>, Array] the matching Whoamitrustedapp items; raises NofrixionError on failure
