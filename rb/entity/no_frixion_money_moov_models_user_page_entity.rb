...
class NoFrixionMoneyMoovModelsUserPageEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "no_frixion_money_moov_models_user_page"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    NoFrixionMoneyMoovModelsUserPageEntity.new(@_client, opts)
  end
  ...
  # @return [NoFrixionMoneyMoovModelsUserPage, Hash] the current NoFrixionMoneyMoovModelsUserPage data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of NoFrixionMoneyMoovModelsUserPage fields)
  def match_get
  ...
  #
  # @param reqmatch [NoFrixionMoneyMoovModelsUserPageListMatch, Hash, nil] match filter (any subset of
  #   NoFrixionMoneyMoovModelsUserPage fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<NoFrixionMoneyMoovModelsUserPage>, Array] the matching NoFrixionMoneyMoovModelsUserPage items; raises NofrixionError on failure
