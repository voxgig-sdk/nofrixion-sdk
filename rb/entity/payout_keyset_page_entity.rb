...
class PayoutKeysetPageEntity
  ...
  def make
    opts = @_entopts.dup
    PayoutKeysetPageEntity.new(@_client, opts)
  end
  ...
  # @return [PayoutKeysetPage, Hash] the current PayoutKeysetPage data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of PayoutKeysetPage fields)
  def match_get
  ...
  #
  # @param reqmatch [PayoutKeysetPageListMatch, Hash, nil] match filter (any subset of
  #   PayoutKeysetPage fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<PayoutKeysetPage>, Array] the matching PayoutKeysetPage items; raises NofrixionError on failure
