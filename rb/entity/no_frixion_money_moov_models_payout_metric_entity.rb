...
class NoFrixionMoneyMoovModelsPayoutMetricEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "no_frixion_money_moov_models_payout_metric"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    NoFrixionMoneyMoovModelsPayoutMetricEntity.new(@_client, opts)
  end
  ...
  # @return [NoFrixionMoneyMoovModelsPayoutMetric, Hash] the current NoFrixionMoneyMoovModelsPayoutMetric data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of NoFrixionMoneyMoovModelsPayoutMetric fields)
  def match_get
  ...
  #
  # @param reqmatch [NoFrixionMoneyMoovModelsPayoutMetricLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.NoFrixionMoneyMoovModelsPayoutMetric.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [NoFrixionMoneyMoovModelsPayoutMetric, Hash] the loaded NoFrixionMoneyMoovModelsPayoutMetric; raises NofrixionError on failure
