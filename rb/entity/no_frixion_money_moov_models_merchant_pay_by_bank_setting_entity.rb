...
class NoFrixionMoneyMoovModelsMerchantPayByBankSettingEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "no_frixion_money_moov_models_merchant_pay_by_bank_setting"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    NoFrixionMoneyMoovModelsMerchantPayByBankSettingEntity.new(@_client, opts)
  end
  ...
  # @return [NoFrixionMoneyMoovModelsMerchantPayByBankSetting, Hash] the current NoFrixionMoneyMoovModelsMerchantPayByBankSetting data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of NoFrixionMoneyMoovModelsMerchantPayByBankSetting fields)
  def match_get
  ...
  #
  # @param reqmatch [NoFrixionMoneyMoovModelsMerchantPayByBankSettingListMatch, Hash, nil] match filter (any subset of
  #   NoFrixionMoneyMoovModelsMerchantPayByBankSetting fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<NoFrixionMoneyMoovModelsMerchantPayByBankSetting>, Array] the matching NoFrixionMoneyMoovModelsMerchantPayByBankSetting items; raises NofrixionError on failure
