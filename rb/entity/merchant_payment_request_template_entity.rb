...
class MerchantPaymentRequestTemplateEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "merchant_payment_request_template"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    MerchantPaymentRequestTemplateEntity.new(@_client, opts)
  end
  ...
  # @return [MerchantPaymentRequestTemplate, Hash] the current MerchantPaymentRequestTemplate data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of MerchantPaymentRequestTemplate fields)
  def match_get
  ...
  #
  # @param reqmatch [MerchantPaymentRequestTemplateLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.MerchantPaymentRequestTemplate.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [MerchantPaymentRequestTemplate, Hash] the loaded MerchantPaymentRequestTemplate; raises NofrixionError on failure
  ...
  #
  # @param reqmatch [MerchantPaymentRequestTemplateListMatch, Hash, nil] match filter (any subset of
  #   MerchantPaymentRequestTemplate fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<MerchantPaymentRequestTemplate>, Array] the matching MerchantPaymentRequestTemplate items; raises NofrixionError on failure
  ...
  #
  # @param reqdata [MerchantPaymentRequestTemplateUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [MerchantPaymentRequestTemplate, Hash] the updated MerchantPaymentRequestTemplate; raises NofrixionError on failure
  ...
  #
  # @param reqmatch [MerchantPaymentRequestTemplateRemoveMatch, Hash, nil] match criteria (id/query fields)
  # @param ctrl [Object, nil] optional per-call control
  # @return [MerchantPaymentRequestTemplate, Hash] the removed MerchantPaymentRequestTemplate; raises NofrixionError on failure
