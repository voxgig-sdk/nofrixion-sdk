...
class TagEntity
  ...
  #
  # @param reqmatch [TagListMatch, Hash, nil] match filter (any subset of
  #   Tag fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Tag>, Array] the matching Tag items; raises NofrixionError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Tag, Hash] the created Tag; raises NofrixionError on failure
