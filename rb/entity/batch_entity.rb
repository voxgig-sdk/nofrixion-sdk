...
class BatchEntity
  ...
  # @return [Batch, Hash] the loaded Batch; raises NofrixionError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Batch, Hash] the created Batch; raises NofrixionError on failure
