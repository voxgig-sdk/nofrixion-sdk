...
class FxRateEntity
  ...
  # @return [FxRate, Hash] the current FxRate data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of FxRate fields)
  def match_get
  ...
  #
  # @param reqmatch [FxRateLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.FxRate.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [FxRate, Hash] the loaded FxRate; raises NofrixionError on failure
  ...
  #
  # @param reqmatch [FxRateListMatch, Hash, nil] match filter (any subset of
  #   FxRate fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<FxRate>, Array] the matching FxRate items; raises NofrixionError on failure
