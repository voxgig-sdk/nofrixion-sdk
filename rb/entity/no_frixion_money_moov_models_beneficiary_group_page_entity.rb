...
class NoFrixionMoneyMoovModelsBeneficiaryGroupPageEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "no_frixion_money_moov_models_beneficiary_group_page"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    NoFrixionMoneyMoovModelsBeneficiaryGroupPageEntity.new(@_client, opts)
  end
  ...
  # @return [NoFrixionMoneyMoovModelsBeneficiaryGroupPage, Hash] the current NoFrixionMoneyMoovModelsBeneficiaryGroupPage data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of NoFrixionMoneyMoovModelsBeneficiaryGroupPage fields)
  def match_get
  ...
  #
  # @param reqmatch [NoFrixionMoneyMoovModelsBeneficiaryGroupPageListMatch, Hash, nil] match filter (any subset of
  #   NoFrixionMoneyMoovModelsBeneficiaryGroupPage fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<NoFrixionMoneyMoovModelsBeneficiaryGroupPage>, Array] the matching NoFrixionMoneyMoovModelsBeneficiaryGroupPage items; raises NofrixionError on failure
