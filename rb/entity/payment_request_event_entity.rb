...
class PaymentRequestEventEntity
  ...
  def make
    opts = @_entopts.dup
    PaymentRequestEventEntity.new(@_client, opts)
  end
  ...
  # @return [PaymentRequestEvent, Hash] the current PaymentRequestEvent data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of PaymentRequestEvent fields)
  def match_get
  ...
  #
  # @param reqmatch [PaymentRequestEventListMatch, Hash, nil] match filter (any subset of
  #   PaymentRequestEvent fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<PaymentRequestEvent>, Array] the matching PaymentRequestEvent items; raises NofrixionError on failure
