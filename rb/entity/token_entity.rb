...
class TokenEntity
  ...
  # Create a new Token.
  #
  # @param reqdata [TokenCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Token, Hash] the created Token; raises NofrixionError on failure
  ...
  #
  # @param reqmatch [TokenRemoveMatch, Hash, nil] match criteria (id/query fields)
  # @param ctrl [Object, nil] optional per-call control
  # @return [Token, Hash] the removed Token; raises NofrixionError on failure
