...
class NoFrixionMoneyMoovModelsReportResultEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "no_frixion_money_moov_models_report_result"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    NoFrixionMoneyMoovModelsReportResultEntity.new(@_client, opts)
  end
  ...
  # @return [NoFrixionMoneyMoovModelsReportResult, Hash] the current NoFrixionMoneyMoovModelsReportResult data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of NoFrixionMoneyMoovModelsReportResult fields)
  def match_get
  ...
  #
  # @param reqmatch [NoFrixionMoneyMoovModelsReportResultLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.NoFrixionMoneyMoovModelsReportResult.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [NoFrixionMoneyMoovModelsReportResult, Hash] the loaded NoFrixionMoneyMoovModelsReportResult; raises NofrixionError on failure
