...
class PaymentRequestEntity
  ...
  def make
    opts = @_entopts.dup
    PaymentRequestEntity.new(@_client, opts)
  end
  ...
  # @return [PaymentRequest, Hash] the current PaymentRequest data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of PaymentRequest fields)
  def match_get
  ...
  #
  # @param reqmatch [PaymentRequestLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.PaymentRequest.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [PaymentRequest, Hash] the loaded PaymentRequest; raises NofrixionError on failure
  ...
  #
  # @param reqmatch [PaymentRequestListMatch, Hash, nil] match filter (any subset of
  #   PaymentRequest fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<PaymentRequest>, Array] the matching PaymentRequest items; raises NofrixionError on failure
  ...
  #
  # @param reqdata [PaymentRequestCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [PaymentRequest, Hash] the created PaymentRequest; raises NofrixionError on failure
  ...
  #
  # @param reqdata [PaymentRequestUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [PaymentRequest, Hash] the updated PaymentRequest; raises NofrixionError on failure
  ...
  #
  # @param reqmatch [PaymentRequestRemoveMatch, Hash, nil] match criteria (id/query fields)
  # @param ctrl [Object, nil] optional per-call control
  # @return [PaymentRequest, Hash] the removed PaymentRequest; raises NofrixionError on failure
