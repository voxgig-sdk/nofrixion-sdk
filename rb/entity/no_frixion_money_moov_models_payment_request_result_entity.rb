...
class NoFrixionMoneyMoovModelsPaymentRequestResultEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "no_frixion_money_moov_models_payment_request_result"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    NoFrixionMoneyMoovModelsPaymentRequestResultEntity.new(@_client, opts)
  end
  ...
  # @return [NoFrixionMoneyMoovModelsPaymentRequestResult, Hash] the current NoFrixionMoneyMoovModelsPaymentRequestResult data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of NoFrixionMoneyMoovModelsPaymentRequestResult fields)
  def match_get
  ...
  #
  # @param reqmatch [NoFrixionMoneyMoovModelsPaymentRequestResultListMatch, Hash, nil] match filter (any subset of
  #   NoFrixionMoneyMoovModelsPaymentRequestResult fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<NoFrixionMoneyMoovModelsPaymentRequestResult>, Array] the matching NoFrixionMoneyMoovModelsPaymentRequestResult items; raises NofrixionError on failure
