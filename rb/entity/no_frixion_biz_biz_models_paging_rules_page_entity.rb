...
class NoFrixionBizBizModelsPagingRulesPageEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "no_frixion_biz_biz_models_paging_rules_page"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    NoFrixionBizBizModelsPagingRulesPageEntity.new(@_client, opts)
  end
  ...
  # @return [NoFrixionBizBizModelsPagingRulesPage, Hash] the current NoFrixionBizBizModelsPagingRulesPage data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of NoFrixionBizBizModelsPagingRulesPage fields)
  def match_get
  ...
  #
  # @param reqmatch [NoFrixionBizBizModelsPagingRulesPageListMatch, Hash, nil] match filter (any subset of
  #   NoFrixionBizBizModelsPagingRulesPage fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<NoFrixionBizBizModelsPagingRulesPage>, Array] the matching NoFrixionBizBizModelsPagingRulesPage items; raises NofrixionError on failure
