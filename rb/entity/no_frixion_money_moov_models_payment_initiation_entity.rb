...
class NoFrixionMoneyMoovModelsPaymentInitiationEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "no_frixion_money_moov_models_payment_initiation"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    NoFrixionMoneyMoovModelsPaymentInitiationEntity.new(@_client, opts)
  end
  ...
  # @return [NoFrixionMoneyMoovModelsPaymentInitiation, Hash] the current NoFrixionMoneyMoovModelsPaymentInitiation data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of NoFrixionMoneyMoovModelsPaymentInitiation fields)
  def match_get
  ...
  #
  # @param reqdata [NoFrixionMoneyMoovModelsPaymentInitiationCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [NoFrixionMoneyMoovModelsPaymentInitiation, Hash] the created NoFrixionMoneyMoovModelsPaymentInitiation; raises NofrixionError on failure
