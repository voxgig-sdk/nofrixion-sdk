...
class RejectEntity
  ...
  # @return [Reject, Hash] the current Reject data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Reject fields)
  def match_get
  ...
  #
  # @param reqdata [RejectUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Reject, Hash] the updated Reject; raises NofrixionError on failure
