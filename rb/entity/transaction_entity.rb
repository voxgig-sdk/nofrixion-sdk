# Nofrixion SDK Transaction entity
...
class TransactionEntity
  ...
  # @return [Transaction, Hash] the loaded Transaction; raises NofrixionError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Transaction>, Array] the matching Transaction items; raises NofrixionError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Transaction, Hash] the created Transaction; raises NofrixionError on failure
  ...
  # Remove an Transaction matching the given criteria.
  #
  # @param reqmatch [TransactionRemoveMatch, Hash, nil] match criteria (id/query fields)
  # @param ctrl [Object, nil] optional per-call control
  # @return [Transaction, Hash] the removed Transaction; raises NofrixionError on failure
