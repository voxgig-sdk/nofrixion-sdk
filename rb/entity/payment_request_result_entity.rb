...
class PaymentRequestResultEntity
  ...
  def make
    opts = @_entopts.dup
    PaymentRequestResultEntity.new(@_client, opts)
  end
  ...
  # @return [PaymentRequestResult, Hash] the current PaymentRequestResult data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of PaymentRequestResult fields)
  def match_get
  ...
  #
  # @param reqmatch [PaymentRequestResultListMatch, Hash, nil] match filter (any subset of
  #   PaymentRequestResult fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<PaymentRequestResult>, Array] the matching PaymentRequestResult items; raises NofrixionError on failure
