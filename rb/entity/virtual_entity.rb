...
class VirtualEntity
  ...
  def make
    opts = @_entopts.dup
    VirtualEntity.new(@_client, opts)
  end
  ...
  # @return [Virtual, Hash] the current Virtual data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Virtual fields)
  def match_get
  ...
  #
  # @param reqdata [VirtualCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Virtual, Hash] the created Virtual; raises NofrixionError on failure
  ...
  #
  # @param reqdata [VirtualUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Virtual, Hash] the updated Virtual; raises NofrixionError on failure
