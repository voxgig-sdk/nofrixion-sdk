...
class PaymentRequestMinimalEntity
  ...
  def make
    opts = @_entopts.dup
    PaymentRequestMinimalEntity.new(@_client, opts)
  end
  ...
  # @return [PaymentRequestMinimal, Hash] the current PaymentRequestMinimal data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of PaymentRequestMinimal fields)
  def match_get
  ...
  #
  # @param reqmatch [PaymentRequestMinimalListMatch, Hash, nil] match filter (any subset of
  #   PaymentRequestMinimal fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<PaymentRequestMinimal>, Array] the matching PaymentRequestMinimal items; raises NofrixionError on failure
