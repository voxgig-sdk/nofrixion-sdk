...
class PaymentEntity
  ...
  # @return [Payment, Hash] the loaded Payment; raises NofrixionError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Payment, Hash] the created Payment; raises NofrixionError on failure
  ...
  #
  # @param reqdata [PaymentUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Payment, Hash] the updated Payment; raises NofrixionError on failure
