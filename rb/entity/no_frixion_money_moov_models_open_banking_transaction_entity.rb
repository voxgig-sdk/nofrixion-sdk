...
class NoFrixionMoneyMoovModelsOpenBankingTransactionEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "no_frixion_money_moov_models_open_banking_transaction"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    NoFrixionMoneyMoovModelsOpenBankingTransactionEntity.new(@_client, opts)
  end
  ...
  # @return [NoFrixionMoneyMoovModelsOpenBankingTransaction, Hash] the current NoFrixionMoneyMoovModelsOpenBankingTransaction data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of NoFrixionMoneyMoovModelsOpenBankingTransaction fields)
  def match_get
  ...
  #
  # @param reqmatch [NoFrixionMoneyMoovModelsOpenBankingTransactionListMatch, Hash, nil] match filter (any subset of
  #   NoFrixionMoneyMoovModelsOpenBankingTransaction fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<NoFrixionMoneyMoovModelsOpenBankingTransaction>, Array] the matching NoFrixionMoneyMoovModelsOpenBankingTransaction items; raises NofrixionError on failure
