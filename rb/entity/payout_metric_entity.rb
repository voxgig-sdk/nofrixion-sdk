...
class PayoutMetricEntity
  ...
  def make
    opts = @_entopts.dup
    PayoutMetricEntity.new(@_client, opts)
  end
  ...
  # @return [PayoutMetric, Hash] the current PayoutMetric data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of PayoutMetric fields)
  def match_get
  ...
  #
  # @param reqmatch [PayoutMetricLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.PayoutMetric.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [PayoutMetric, Hash] the loaded PayoutMetric; raises NofrixionError on failure
