...
class OpenBankingEntity
  ...
  def make
    opts = @_entopts.dup
    OpenBankingEntity.new(@_client, opts)
  end
  ...
  # @return [OpenBanking, Hash] the current OpenBanking data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of OpenBanking fields)
  def match_get
  ...
  #
  # @param reqdata [OpenBankingCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [OpenBanking, Hash] the created OpenBanking; raises NofrixionError on failure
  ...
  #
  # @param reqmatch [OpenBankingRemoveMatch, Hash, nil] match criteria (id/query fields)
  # @param ctrl [Object, nil] optional per-call control
  # @return [OpenBanking, Hash] the removed OpenBanking; raises NofrixionError on failure
