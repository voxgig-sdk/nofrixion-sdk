...
class UserInvitesCreateEntity
  ...
  def make
    opts = @_entopts.dup
    UserInvitesCreateEntity.new(@_client, opts)
  end
  ...
  # @return [UserInvitesCreate, Hash] the current UserInvitesCreate data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of UserInvitesCreate fields)
  def match_get
  ...
  #
  # @param reqdata [UserInvitesCreateCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [UserInvitesCreate, Hash] the created UserInvitesCreate; raises NofrixionError on failure
