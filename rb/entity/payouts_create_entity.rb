...
class PayoutsCreateEntity
  ...
  def make
    opts = @_entopts.dup
    PayoutsCreateEntity.new(@_client, opts)
  end
  ...
  # @return [PayoutsCreate, Hash] the current PayoutsCreate data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of PayoutsCreate fields)
  def match_get
  ...
  #
  # @param reqdata [PayoutsCreateCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [PayoutsCreate, Hash] the created PayoutsCreate; raises NofrixionError on failure
