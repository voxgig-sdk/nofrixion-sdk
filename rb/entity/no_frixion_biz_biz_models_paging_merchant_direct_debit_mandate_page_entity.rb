...
class NoFrixionBizBizModelsPagingMerchantDirectDebitMandatePageEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "no_frixion_biz_biz_models_paging_merchant_direct_debit_mandate_page"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    NoFrixionBizBizModelsPagingMerchantDirectDebitMandatePageEntity.new(@_client, opts)
  end
  ...
  # @return [NoFrixionBizBizModelsPagingMerchantDirectDebitMandatePage, Hash] the current NoFrixionBizBizModelsPagingMerchantDirectDebitMandatePage data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of NoFrixionBizBizModelsPagingMerchantDirectDebitMandatePage fields)
  def match_get
  ...
  #
  # @param reqmatch [NoFrixionBizBizModelsPagingMerchantDirectDebitMandatePageListMatch, Hash, nil] match filter (any subset of
  #   NoFrixionBizBizModelsPagingMerchantDirectDebitMandatePage fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<NoFrixionBizBizModelsPagingMerchantDirectDebitMandatePage>, Array] the matching NoFrixionBizBizModelsPagingMerchantDirectDebitMandatePage items; raises NofrixionError on failure
