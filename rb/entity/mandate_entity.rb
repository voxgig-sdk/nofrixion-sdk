...
class MandateEntity
  ...
  def make
    opts = @_entopts.dup
    MandateEntity.new(@_client, opts)
  end
  ...
  # @return [Mandate, Hash] the current Mandate data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Mandate fields)
  def match_get
  ...
  #
  # @param reqmatch [MandateLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Mandate.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Mandate, Hash] the loaded Mandate; raises NofrixionError on failure
  ...
  #
  # @param reqdata [MandateCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Mandate, Hash] the created Mandate; raises NofrixionError on failure
