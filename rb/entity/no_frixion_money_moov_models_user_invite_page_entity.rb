...
class NoFrixionMoneyMoovModelsUserInvitePageEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "no_frixion_money_moov_models_user_invite_page"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    NoFrixionMoneyMoovModelsUserInvitePageEntity.new(@_client, opts)
  end
  ...
  # @return [NoFrixionMoneyMoovModelsUserInvitePage, Hash] the current NoFrixionMoneyMoovModelsUserInvitePage data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of NoFrixionMoneyMoovModelsUserInvitePage fields)
  def match_get
  ...
  #
  # @param reqmatch [NoFrixionMoneyMoovModelsUserInvitePageListMatch, Hash, nil] match filter (any subset of
  #   NoFrixionMoneyMoovModelsUserInvitePage fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<NoFrixionMoneyMoovModelsUserInvitePage>, Array] the matching NoFrixionMoneyMoovModelsUserInvitePage items; raises NofrixionError on failure
