...
class NoFrixionMoneyMoovModelsPaymentRequestEventEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "no_frixion_money_moov_models_payment_request_event"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    NoFrixionMoneyMoovModelsPaymentRequestEventEntity.new(@_client, opts)
  end
  ...
  # @return [NoFrixionMoneyMoovModelsPaymentRequestEvent, Hash] the current NoFrixionMoneyMoovModelsPaymentRequestEvent data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of NoFrixionMoneyMoovModelsPaymentRequestEvent fields)
  def match_get
  ...
  #
  # @param reqmatch [NoFrixionMoneyMoovModelsPaymentRequestEventListMatch, Hash, nil] match filter (any subset of
  #   NoFrixionMoneyMoovModelsPaymentRequestEvent fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<NoFrixionMoneyMoovModelsPaymentRequestEvent>, Array] the matching NoFrixionMoneyMoovModelsPaymentRequestEvent items; raises NofrixionError on failure
