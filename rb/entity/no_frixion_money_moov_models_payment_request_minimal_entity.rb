...
class NoFrixionMoneyMoovModelsPaymentRequestMinimalEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "no_frixion_money_moov_models_payment_request_minimal"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    NoFrixionMoneyMoovModelsPaymentRequestMinimalEntity.new(@_client, opts)
  end
  ...
  # @return [NoFrixionMoneyMoovModelsPaymentRequestMinimal, Hash] the current NoFrixionMoneyMoovModelsPaymentRequestMinimal data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of NoFrixionMoneyMoovModelsPaymentRequestMinimal fields)
  def match_get
  ...
  #
  # @param reqmatch [NoFrixionMoneyMoovModelsPaymentRequestMinimalListMatch, Hash, nil] match filter (any subset of
  #   NoFrixionMoneyMoovModelsPaymentRequestMinimal fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<NoFrixionMoneyMoovModelsPaymentRequestMinimal>, Array] the matching NoFrixionMoneyMoovModelsPaymentRequestMinimal items; raises NofrixionError on failure
