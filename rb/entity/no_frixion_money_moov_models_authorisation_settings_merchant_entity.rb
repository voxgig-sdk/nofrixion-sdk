...
class NoFrixionMoneyMoovModelsAuthorisationSettingsMerchantEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "no_frixion_money_moov_models_authorisation_settings_merchant"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    NoFrixionMoneyMoovModelsAuthorisationSettingsMerchantEntity.new(@_client, opts)
  end
  ...
  # @return [NoFrixionMoneyMoovModelsAuthorisationSettingsMerchant, Hash] the current NoFrixionMoneyMoovModelsAuthorisationSettingsMerchant data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of NoFrixionMoneyMoovModelsAuthorisationSettingsMerchant fields)
  def match_get
  ...
  #
  # @param reqmatch [NoFrixionMoneyMoovModelsAuthorisationSettingsMerchantListMatch, Hash, nil] match filter (any subset of
  #   NoFrixionMoneyMoovModelsAuthorisationSettingsMerchant fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<NoFrixionMoneyMoovModelsAuthorisationSettingsMerchant>, Array] the matching NoFrixionMoneyMoovModelsAuthorisationSettingsMerchant items; raises NofrixionError on failure
