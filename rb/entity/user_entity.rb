...
class UserEntity
  ...
  # @return [Array<User>, Array] the matching User items; raises NofrixionError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [User, Hash] the updated User; raises NofrixionError on failure
