...
class PaymentAccountEntity
  ...
  def make
    opts = @_entopts.dup
    PaymentAccountEntity.new(@_client, opts)
  end
  ...
  # @return [PaymentAccount, Hash] the current PaymentAccount data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of PaymentAccount fields)
  def match_get
  ...
  #
  # @param reqmatch [PaymentAccountListMatch, Hash, nil] match filter (any subset of
  #   PaymentAccount fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<PaymentAccount>, Array] the matching PaymentAccount items; raises NofrixionError on failure
