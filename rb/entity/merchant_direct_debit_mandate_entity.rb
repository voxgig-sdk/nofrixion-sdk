...
class MerchantDirectDebitMandateEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "merchant_direct_debit_mandate"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    MerchantDirectDebitMandateEntity.new(@_client, opts)
  end
  ...
  # @return [MerchantDirectDebitMandate, Hash] the current MerchantDirectDebitMandate data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of MerchantDirectDebitMandate fields)
  def match_get
  ...
  #
  # @param reqmatch [MerchantDirectDebitMandateListMatch, Hash, nil] match filter (any subset of
  #   MerchantDirectDebitMandate fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<MerchantDirectDebitMandate>, Array] the matching MerchantDirectDebitMandate items; raises NofrixionError on failure
