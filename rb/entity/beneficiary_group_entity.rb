...
class BeneficiaryGroupEntity
  ...
  def make
    opts = @_entopts.dup
    BeneficiaryGroupEntity.new(@_client, opts)
  end
  ...
  # @return [BeneficiaryGroup, Hash] the current BeneficiaryGroup data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of BeneficiaryGroup fields)
  def match_get
  ...
  #
  # @param reqmatch [BeneficiaryGroupListMatch, Hash, nil] match filter (any subset of
  #   BeneficiaryGroup fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<BeneficiaryGroup>, Array] the matching BeneficiaryGroup items; raises NofrixionError on failure
