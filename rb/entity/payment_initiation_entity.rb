...
class PaymentInitiationEntity
  ...
  def make
    opts = @_entopts.dup
    PaymentInitiationEntity.new(@_client, opts)
  end
  ...
  # @return [PaymentInitiation, Hash] the current PaymentInitiation data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of PaymentInitiation fields)
  def match_get
  ...
  #
  # @param reqdata [PaymentInitiationCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [PaymentInitiation, Hash] the created PaymentInitiation; raises NofrixionError on failure
