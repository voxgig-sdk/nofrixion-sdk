...
class CancelEntity
  ...
  # @return [Cancel, Hash] the current Cancel data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Cancel fields)
  def match_get
  ...
  #
  # @param reqdata [CancelUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Cancel, Hash] the updated Cancel; raises NofrixionError on failure
