...
class MerchantAuthorisationSettingEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "merchant_authorisation_setting"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    MerchantAuthorisationSettingEntity.new(@_client, opts)
  end
  ...
  # @return [MerchantAuthorisationSetting, Hash] the current MerchantAuthorisationSetting data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of MerchantAuthorisationSetting fields)
  def match_get
  ...
  #
  # @param reqmatch [MerchantAuthorisationSettingListMatch, Hash, nil] match filter (any subset of
  #   MerchantAuthorisationSetting fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<MerchantAuthorisationSetting>, Array] the matching MerchantAuthorisationSetting items; raises NofrixionError on failure
