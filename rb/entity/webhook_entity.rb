...
class WebhookEntity
  ...
  # @return [Webhook, Hash] the loaded Webhook; raises NofrixionError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Webhook>, Array] the matching Webhook items; raises NofrixionError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Webhook, Hash] the created Webhook; raises NofrixionError on failure
  ...
  #
  # @param reqdata [WebhookUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Webhook, Hash] the updated Webhook; raises NofrixionError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Webhook, Hash] the removed Webhook; raises NofrixionError on failure
