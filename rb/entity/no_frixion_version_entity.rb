...
class NoFrixionVersionEntity
  ...
  def make
    opts = @_entopts.dup
    NoFrixionVersionEntity.new(@_client, opts)
  end
  ...
  # @return [NoFrixionVersion, Hash] the current NoFrixionVersion data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of NoFrixionVersion fields)
  def match_get
  ...
  #
  # @param reqmatch [NoFrixionVersionLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.NoFrixionVersion.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [NoFrixionVersion, Hash] the loaded NoFrixionVersion; raises NofrixionError on failure
