...
class NoFrixionMoneyMoovModelsMerchantTokenPageEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "no_frixion_money_moov_models_merchant_token_page"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    NoFrixionMoneyMoovModelsMerchantTokenPageEntity.new(@_client, opts)
  end
  ...
  # @return [NoFrixionMoneyMoovModelsMerchantTokenPage, Hash] the current NoFrixionMoneyMoovModelsMerchantTokenPage data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of NoFrixionMoneyMoovModelsMerchantTokenPage fields)
  def match_get
  ...
  #
  # @param reqmatch [NoFrixionMoneyMoovModelsMerchantTokenPageListMatch, Hash, nil] match filter (any subset of
  #   NoFrixionMoneyMoovModelsMerchantTokenPage fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<NoFrixionMoneyMoovModelsMerchantTokenPage>, Array] the matching NoFrixionMoneyMoovModelsMerchantTokenPage items; raises NofrixionError on failure
