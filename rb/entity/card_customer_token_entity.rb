...
class CardCustomerTokenEntity
  ...
  def make
    opts = @_entopts.dup
    CardCustomerTokenEntity.new(@_client, opts)
  end
  ...
  # @return [CardCustomerToken, Hash] the current CardCustomerToken data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of CardCustomerToken fields)
  def match_get
  ...
  #
  # @param reqmatch [CardCustomerTokenLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.CardCustomerToken.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [CardCustomerToken, Hash] the loaded CardCustomerToken; raises NofrixionError on failure
  ...
  #
  # @param reqmatch [CardCustomerTokenListMatch, Hash, nil] match filter (any subset of
  #   CardCustomerToken fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<CardCustomerToken>, Array] the matching CardCustomerToken items; raises NofrixionError on failure
  ...
  #
  # @param reqmatch [CardCustomerTokenRemoveMatch, Hash, nil] match criteria (id/query fields)
  # @param ctrl [Object, nil] optional per-call control
  # @return [CardCustomerToken, Hash] the removed CardCustomerToken; raises NofrixionError on failure
