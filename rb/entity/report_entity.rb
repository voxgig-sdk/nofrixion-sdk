...
class ReportEntity
  ...
  # @return [Report, Hash] the current Report data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Report fields)
  def match_get
  ...
  #
  # @param reqdata [ReportUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Report, Hash] the updated Report; raises NofrixionError on failure
