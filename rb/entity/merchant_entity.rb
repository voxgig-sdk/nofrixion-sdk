...
class MerchantEntity
  ...
  # @return [Merchant, Hash] the loaded Merchant; raises NofrixionError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Merchant>, Array] the matching Merchant items; raises NofrixionError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Merchant, Hash] the updated Merchant; raises NofrixionError on failure
  ...
  # Remove an Merchant matching the given criteria.
  #
  # @param reqmatch [MerchantRemoveMatch, Hash, nil] match criteria (id/query fields)
  # @param ctrl [Object, nil] optional per-call control
  # @return [Merchant, Hash] the removed Merchant; raises NofrixionError on failure
