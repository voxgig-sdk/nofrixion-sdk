...
class IPaymentEntity
  ...
  def make
    opts = @_entopts.dup
    IPaymentEntity.new(@_client, opts)
  end
  ...
  # @return [IPayment, Hash] the current IPayment data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of IPayment fields)
  def match_get
  ...
  #
  # @param reqdata [IPaymentCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [IPayment, Hash] the created IPayment; raises NofrixionError on failure
