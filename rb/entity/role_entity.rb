...
class RoleEntity
  ...
  # @return [Role, Hash] the current Role data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Role fields)
  def match_get
  ...
  # Create a new Role.
  #
  # @param reqdata [RoleCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Role, Hash] the created Role; raises NofrixionError on failure
