...
describe("PayoutMetricDirect", function()
  it("should direct-load-payout_metric", function()
    local setup = payout_metric_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-payout_metric", setup.live and "live" or "unit")
...
function payout_metric_direct_setup(mockres)
