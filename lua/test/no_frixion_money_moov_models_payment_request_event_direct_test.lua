...
describe("NoFrixionMoneyMoovModelsPaymentRequestEventDirect", function()
  it("should direct-list-no_frixion_money_moov_models_payment_request_event", function()
    local setup = no_frixion_money_moov_models_payment_request_event_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-no_frixion_money_moov_models_payment_request_event", setup.live and "live" or "unit")
