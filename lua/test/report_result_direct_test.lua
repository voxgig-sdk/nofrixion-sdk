...
describe("ReportResultDirect", function()
  it("should direct-load-report_result", function()
    local setup = report_result_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-report_result", setup.live and "live" or "unit")
...
function report_result_direct_setup(mockres)
