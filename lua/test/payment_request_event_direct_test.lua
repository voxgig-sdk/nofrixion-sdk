-- PaymentRequestEvent direct test
...
describe("PaymentRequestEventDirect", function()
  it("should direct-list-payment_request_event", function()
    local setup = payment_request_event_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-payment_request_event", setup.live and "live" or "unit")
...
function payment_request_event_direct_setup(mockres)
