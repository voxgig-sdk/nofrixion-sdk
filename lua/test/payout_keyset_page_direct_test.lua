...
describe("PayoutKeysetPageDirect", function()
  it("should direct-list-payout_keyset_page", function()
    local setup = payout_keyset_page_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-payout_keyset_page", setup.live and "live" or "unit")
...
function payout_keyset_page_direct_setup(mockres)
