-- NoFrixionMoneyMoovModelsBatchPayout direct test
...
describe("NoFrixionMoneyMoovModelsBatchPayoutDirect", function()
  it("should direct-load-no_frixion_money_moov_models_batch_payout", function()
    local setup = no_frixion_money_moov_models_batch_payout_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-no_frixion_money_moov_models_batch_payout", setup.live and "live" or "unit")
...
function no_frixion_money_moov_models_batch_payout_direct_setup(mockres)
