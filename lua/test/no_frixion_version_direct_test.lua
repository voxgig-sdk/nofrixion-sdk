...
describe("NoFrixionVersionDirect", function()
  it("should direct-load-no_frixion_version", function()
    local setup = no_frixion_version_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-no_frixion_version", setup.live and "live" or "unit")
...
function no_frixion_version_direct_setup(mockres)
