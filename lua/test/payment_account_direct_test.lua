...
describe("PaymentAccountDirect", function()
  it("should direct-list-payment_account", function()
    local setup = payment_account_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-payment_account", setup.live and "live" or "unit")
...
function payment_account_direct_setup(mockres)
