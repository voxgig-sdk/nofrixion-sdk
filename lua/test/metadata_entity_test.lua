...
describe("MetadataEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set NOFRIXION_TEST_METADATA_ENTID JSON to run live")
      return
    end
...
function metadata_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("NOFRIXION_TEST_METADATA_ENTID")
