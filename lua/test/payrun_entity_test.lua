...
describe("PayrunEntity", function()
  it("should create instance", function()
    local testsdk = sdk.test(nil, nil)
    local ent = testsdk:Payrun(nil)
  ...
  it("should stream", function()
    ...
    local seen = {}
    for item in base:Payrun(nil):stream("list", nil, nil) do
    ...
    if type(config.feature) == "table" and config.feature.streaming ~= nil then
      ...
      local got = {}
      for item in streamsdk:Payrun(nil):stream("list", nil, nil) do
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set NOFRIXION_TEST_PAYRUN_ENTID JSON to run live")
      return
    end
...
function payrun_basic_setup(extra)
  ...
  local entity_data_file = _test_dir .. "../../.sdk/test/entity/payrun/PayrunTestData.json"
  local f = io.open(entity_data_file, "r")
  if f == nil then
    error("failed to read payrun test data: " .. entity_data_file)
  end
  ...
  local entid_env_raw = os.getenv("NOFRIXION_TEST_PAYRUN_ENTID")
