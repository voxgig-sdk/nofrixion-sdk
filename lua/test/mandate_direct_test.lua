...
describe("MandateDirect", function()
  it("should direct-load-mandate", function()
    local setup = mandate_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-mandate", setup.live and "live" or "unit")
...
function mandate_direct_setup(mockres)
