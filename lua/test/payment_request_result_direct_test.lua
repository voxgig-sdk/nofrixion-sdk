-- PaymentRequestResult direct test
...
describe("PaymentRequestResultDirect", function()
  it("should direct-list-payment_request_result", function()
    local setup = payment_request_result_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-payment_request_result", setup.live and "live" or "unit")
...
function payment_request_result_direct_setup(mockres)
