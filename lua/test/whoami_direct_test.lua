...
describe("WhoamiDirect", function()
  it("should direct-list-whoami", function()
    local setup = whoami_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-whoami", setup.live and "live" or "unit")
...
function whoami_direct_setup(mockres)
