-- NoFrixionMoneyMoovModelsUserInvitePage direct test
...
describe("NoFrixionMoneyMoovModelsUserInvitePageDirect", function()
  it("should direct-list-no_frixion_money_moov_models_user_invite_page", function()
    local setup = no_frixion_money_moov_models_user_invite_page_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-no_frixion_money_moov_models_user_invite_page", setup.live and "live" or "unit")
...
function no_frixion_money_moov_models_user_invite_page_direct_setup(mockres)
