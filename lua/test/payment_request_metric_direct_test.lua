-- PaymentRequestMetric direct test
...
describe("PaymentRequestMetricDirect", function()
  it("should direct-load-payment_request_metric", function()
    local setup = payment_request_metric_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-payment_request_metric", setup.live and "live" or "unit")
...
function payment_request_metric_direct_setup(mockres)
