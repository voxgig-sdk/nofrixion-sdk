...
describe("CardPublicKeyDirect", function()
  it("should direct-load-card_public_key", function()
    local setup = card_public_key_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-card_public_key", setup.live and "live" or "unit")
...
function card_public_key_direct_setup(mockres)
