-- MerchantDirectDebitMandate direct test
...
describe("MerchantDirectDebitMandateDirect", function()
  it("should direct-list-merchant_direct_debit_mandate", function()
    local setup = merchant_direct_debit_mandate_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-merchant_direct_debit_mandate", setup.live and "live" or "unit")
...
function merchant_direct_debit_mandate_direct_setup(mockres)
