...
describe("UserInviteDirect", function()
  it("should direct-list-user_invite", function()
    local setup = user_invite_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-user_invite", setup.live and "live" or "unit")
  ...
  it("should direct-load-user_invite", function()
    local setup = user_invite_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-user_invite", setup.live and "live" or "unit")
    if _should_skip then
      pending(_reason or "skipped via sdk-test-control.json")
      return
    end
...
function user_invite_direct_setup(mockres)
