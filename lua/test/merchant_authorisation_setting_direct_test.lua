-- MerchantAuthorisationSetting direct test
...
describe("MerchantAuthorisationSettingDirect", function()
  it("should direct-list-merchant_authorisation_setting", function()
    local setup = merchant_authorisation_setting_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-merchant_authorisation_setting", setup.live and "live" or "unit")
...
function merchant_authorisation_setting_direct_setup(mockres)
