-- PaymentAccountMinimal direct test
...
describe("PaymentAccountMinimalDirect", function()
  it("should direct-list-payment_account_minimal", function()
    local setup = payment_account_minimal_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-payment_account_minimal", setup.live and "live" or "unit")
...
function payment_account_minimal_direct_setup(mockres)
