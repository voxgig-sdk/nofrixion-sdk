...
describe("BeneficiaryGroupDirect", function()
  it("should direct-list-beneficiary_group", function()
    local setup = beneficiary_group_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-beneficiary_group", setup.live and "live" or "unit")
...
function beneficiary_group_direct_setup(mockres)
