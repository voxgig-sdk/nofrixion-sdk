-- NoFrixionMoneyMoovModelsMerchantToken direct test
...
describe("NoFrixionMoneyMoovModelsMerchantTokenDirect", function()
  it("should direct-load-no_frixion_money_moov_models_merchant_token", function()
    local setup = no_frixion_money_moov_models_merchant_token_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-no_frixion_money_moov_models_merchant_token", setup.live and "live" or "unit")
...
function no_frixion_money_moov_models_merchant_token_direct_setup(mockres)
