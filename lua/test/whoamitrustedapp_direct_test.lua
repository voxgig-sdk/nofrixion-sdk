...
describe("WhoamitrustedappDirect", function()
  it("should direct-list-whoamitrustedapp", function()
    local setup = whoamitrustedapp_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-whoamitrustedapp", setup.live and "live" or "unit")
...
function whoamitrustedapp_direct_setup(mockres)
