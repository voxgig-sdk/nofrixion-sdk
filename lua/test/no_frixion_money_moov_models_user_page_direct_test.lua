-- NoFrixionMoneyMoovModelsUserPage direct test
...
describe("NoFrixionMoneyMoovModelsUserPageDirect", function()
  it("should direct-list-no_frixion_money_moov_models_user_page", function()
    local setup = no_frixion_money_moov_models_user_page_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-no_frixion_money_moov_models_user_page", setup.live and "live" or "unit")
...
function no_frixion_money_moov_models_user_page_direct_setup(mockres)
