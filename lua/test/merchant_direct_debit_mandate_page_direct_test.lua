-- MerchantDirectDebitMandatePage direct test
...
describe("MerchantDirectDebitMandatePageDirect", function()
  it("should direct-list-merchant_direct_debit_mandate_page", function()
    local setup = merchant_direct_debit_mandate_page_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-merchant_direct_debit_mandate_page", setup.live and "live" or "unit")
...
function merchant_direct_debit_mandate_page_direct_setup(mockres)
