-- Nofrixion SDK NoFrixionVersion entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local NoFrixionVersionEntity = {}
NoFrixionVersionEntity.__index = NoFrixionVersionEntity


function NoFrixionVersionEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, NoFrixionVersionEntity)
  self._name = "no_frixion_version"
  self._client = client
...
function NoFrixionVersionEntity:get_name()
  return self._name
end


function NoFrixionVersionEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return NoFrixionVersionEntity.new(self._client, opts)
end
...
function NoFrixionVersionEntity:mark_deleted()
  self._deleted = true
end


function NoFrixionVersionEntity:deleted()
  return true == self._deleted
end


function NoFrixionVersionEntity:data_set(args)
  if args ~= nil then
...
function NoFrixionVersionEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function NoFrixionVersionEntity:match_set(args)
  if args ~= nil then
...
function NoFrixionVersionEntity:match_get()
...
function NoFrixionVersionEntity:stream(action, args, callopts)
...
---@param reqmatch NoFrixionVersionLoadMatch
---@param ctrl? table
---@return NoFrixionVersion
---@return string? err
function NoFrixionVersionEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function NoFrixionVersionEntity:_run_op(ctx, post_done)
  local utility = self._utility
