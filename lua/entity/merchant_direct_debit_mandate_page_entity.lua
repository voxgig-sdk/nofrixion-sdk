-- Nofrixion SDK MerchantDirectDebitMandatePage entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local MerchantDirectDebitMandatePageEntity = {}
MerchantDirectDebitMandatePageEntity.__index = MerchantDirectDebitMandatePageEntity


function MerchantDirectDebitMandatePageEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, MerchantDirectDebitMandatePageEntity)
  self._name = "merchant_direct_debit_mandate_page"
  self._client = client
...
function MerchantDirectDebitMandatePageEntity:get_name()
  return self._name
end


function MerchantDirectDebitMandatePageEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return MerchantDirectDebitMandatePageEntity.new(self._client, opts)
end
...
function MerchantDirectDebitMandatePageEntity:mark_deleted()
  self._deleted = true
end


function MerchantDirectDebitMandatePageEntity:deleted()
  return true == self._deleted
end


function MerchantDirectDebitMandatePageEntity:data_set(args)
  if args ~= nil then
...
function MerchantDirectDebitMandatePageEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function MerchantDirectDebitMandatePageEntity:match_set(args)
  if args ~= nil then
...
function MerchantDirectDebitMandatePageEntity:match_get()
...
function MerchantDirectDebitMandatePageEntity:stream(action, args, callopts)
...
---@param reqmatch MerchantDirectDebitMandatePageListMatch
---@param ctrl? table
---@return MerchantDirectDebitMandatePage[]
---@return string? err
function MerchantDirectDebitMandatePageEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function MerchantDirectDebitMandatePageEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return MerchantDirectDebitMandatePageEntity
