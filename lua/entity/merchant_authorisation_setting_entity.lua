-- Nofrixion SDK MerchantAuthorisationSetting entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local MerchantAuthorisationSettingEntity = {}
MerchantAuthorisationSettingEntity.__index = MerchantAuthorisationSettingEntity


function MerchantAuthorisationSettingEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, MerchantAuthorisationSettingEntity)
  self._name = "merchant_authorisation_setting"
  self._client = client
...
function MerchantAuthorisationSettingEntity:get_name()
  return self._name
end


function MerchantAuthorisationSettingEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return MerchantAuthorisationSettingEntity.new(self._client, opts)
end
...
function MerchantAuthorisationSettingEntity:mark_deleted()
  self._deleted = true
end


function MerchantAuthorisationSettingEntity:deleted()
  return true == self._deleted
end


function MerchantAuthorisationSettingEntity:data_set(args)
  if args ~= nil then
...
function MerchantAuthorisationSettingEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function MerchantAuthorisationSettingEntity:match_set(args)
  if args ~= nil then
...
function MerchantAuthorisationSettingEntity:match_get()
...
function MerchantAuthorisationSettingEntity:stream(action, args, callopts)
...
---@param reqmatch MerchantAuthorisationSettingListMatch
---@param ctrl? table
---@return MerchantAuthorisationSetting[]
---@return string? err
function MerchantAuthorisationSettingEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function MerchantAuthorisationSettingEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return MerchantAuthorisationSettingEntity
