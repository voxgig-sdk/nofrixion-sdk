...
local UserInviteEntity = {}
UserInviteEntity.__index = UserInviteEntity


function UserInviteEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, UserInviteEntity)
  self._name = "user_invite"
  self._client = client
...
function UserInviteEntity:get_name()
  return self._name
end


function UserInviteEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return UserInviteEntity.new(self._client, opts)
end
...
function UserInviteEntity:mark_deleted()
  self._deleted = true
end


function UserInviteEntity:deleted()
  return true == self._deleted
end


function UserInviteEntity:data_set(args)
  if args ~= nil then
...
function UserInviteEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function UserInviteEntity:match_set(args)
  if args ~= nil then
...
function UserInviteEntity:match_get()
...
function UserInviteEntity:stream(action, args, callopts)
...
---@param reqdata UserInviteCreateData
---@param ctrl? table
---@return UserInvite
---@return string? err
function UserInviteEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata UserInviteUpdateData
---@param ctrl? table
---@return UserInvite
---@return string? err
function UserInviteEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
---@param reqmatch UserInviteRemoveMatch
---@param ctrl? table
---@return UserInvite
---@return string? err
function UserInviteEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
...
function UserInviteEntity:_run_op(ctx, post_done)
  local utility = self._utility
