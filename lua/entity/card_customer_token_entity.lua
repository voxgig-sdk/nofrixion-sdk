...
local CardCustomerTokenEntity = {}
CardCustomerTokenEntity.__index = CardCustomerTokenEntity


function CardCustomerTokenEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, CardCustomerTokenEntity)
  self._name = "card_customer_token"
  self._client = client
...
function CardCustomerTokenEntity:get_name()
  return self._name
end


function CardCustomerTokenEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return CardCustomerTokenEntity.new(self._client, opts)
end
...
function CardCustomerTokenEntity:mark_deleted()
  self._deleted = true
end


function CardCustomerTokenEntity:deleted()
  return true == self._deleted
end


function CardCustomerTokenEntity:data_set(args)
  if args ~= nil then
...
function CardCustomerTokenEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function CardCustomerTokenEntity:match_set(args)
  if args ~= nil then
...
function CardCustomerTokenEntity:match_get()
...
function CardCustomerTokenEntity:stream(action, args, callopts)
...
---@param reqmatch CardCustomerTokenLoadMatch
---@param ctrl? table
---@return CardCustomerToken
---@return string? err
function CardCustomerTokenEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch CardCustomerTokenListMatch
---@param ctrl? table
---@return CardCustomerToken[]
---@return string? err
function CardCustomerTokenEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqmatch CardCustomerTokenRemoveMatch
---@param ctrl? table
---@return CardCustomerToken
---@return string? err
function CardCustomerTokenEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
...
function CardCustomerTokenEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return CardCustomerTokenEntity
