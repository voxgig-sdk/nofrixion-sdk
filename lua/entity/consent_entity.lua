...
local ConsentEntity = {}
ConsentEntity.__index = ConsentEntity


function ConsentEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ConsentEntity)
  self._name = "consent"
  self._client = client
...
function ConsentEntity:get_name()
  return self._name
end


function ConsentEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ConsentEntity.new(self._client, opts)
end
...
function ConsentEntity:mark_deleted()
  self._deleted = true
end


function ConsentEntity:deleted()
  return true == self._deleted
end


function ConsentEntity:data_set(args)
  if args ~= nil then
...
function ConsentEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ConsentEntity:match_set(args)
  if args ~= nil then
...
function ConsentEntity:match_get()
...
function ConsentEntity:stream(action, args, callopts)
...
---@param reqmatch ConsentLoadMatch
---@param ctrl? table
---@return Consent
---@return string? err
function ConsentEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch ConsentListMatch
---@param ctrl? table
---@return Consent[]
---@return string? err
function ConsentEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata ConsentCreateData
---@param ctrl? table
---@return Consent
---@return string? err
function ConsentEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata ConsentUpdateData
---@param ctrl? table
---@return Consent
---@return string? err
function ConsentEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
---@param reqmatch ConsentRemoveMatch
---@param ctrl? table
---@return Consent
---@return string? err
function ConsentEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
...
function ConsentEntity:_run_op(ctx, post_done)
  local utility = self._utility
