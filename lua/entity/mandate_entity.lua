...
local MandateEntity = {}
MandateEntity.__index = MandateEntity


function MandateEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, MandateEntity)
  self._name = "mandate"
  self._client = client
...
function MandateEntity:get_name()
  return self._name
end


function MandateEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return MandateEntity.new(self._client, opts)
end
...
function MandateEntity:mark_deleted()
  self._deleted = true
end


function MandateEntity:deleted()
  return true == self._deleted
end


function MandateEntity:data_set(args)
  if args ~= nil then
...
function MandateEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function MandateEntity:match_set(args)
  if args ~= nil then
...
function MandateEntity:match_get()
...
function MandateEntity:stream(action, args, callopts)
...
---@param reqmatch MandateLoadMatch
---@param ctrl? table
---@return Mandate
---@return string? err
function MandateEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata MandateCreateData
---@param ctrl? table
---@return Mandate
---@return string? err
function MandateEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
function MandateEntity:_run_op(ctx, post_done)
  local utility = self._utility
