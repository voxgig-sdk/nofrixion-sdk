-- Nofrixion SDK BeneficiaryGroup entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local BeneficiaryGroupEntity = {}
BeneficiaryGroupEntity.__index = BeneficiaryGroupEntity


function BeneficiaryGroupEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, BeneficiaryGroupEntity)
  self._name = "beneficiary_group"
  self._client = client
...
function BeneficiaryGroupEntity:get_name()
  return self._name
end


function BeneficiaryGroupEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return BeneficiaryGroupEntity.new(self._client, opts)
end
...
function BeneficiaryGroupEntity:mark_deleted()
  self._deleted = true
end


function BeneficiaryGroupEntity:deleted()
  return true == self._deleted
end


function BeneficiaryGroupEntity:data_set(args)
  if args ~= nil then
...
function BeneficiaryGroupEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function BeneficiaryGroupEntity:match_set(args)
  if args ~= nil then
...
function BeneficiaryGroupEntity:match_get()
...
function BeneficiaryGroupEntity:stream(action, args, callopts)
...
---@param reqmatch BeneficiaryGroupListMatch
---@param ctrl? table
---@return BeneficiaryGroup[]
---@return string? err
function BeneficiaryGroupEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function BeneficiaryGroupEntity:_run_op(ctx, post_done)
  local utility = self._utility
