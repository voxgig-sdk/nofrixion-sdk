...
local MerchantPaymentRequestTemplateEntity = {}
MerchantPaymentRequestTemplateEntity.__index = MerchantPaymentRequestTemplateEntity


function MerchantPaymentRequestTemplateEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, MerchantPaymentRequestTemplateEntity)
  self._name = "merchant_payment_request_template"
  self._client = client
...
function MerchantPaymentRequestTemplateEntity:get_name()
  return self._name
end


function MerchantPaymentRequestTemplateEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return MerchantPaymentRequestTemplateEntity.new(self._client, opts)
end
...
function MerchantPaymentRequestTemplateEntity:mark_deleted()
  self._deleted = true
end


function MerchantPaymentRequestTemplateEntity:deleted()
  return true == self._deleted
end


function MerchantPaymentRequestTemplateEntity:data_set(args)
  if args ~= nil then
...
function MerchantPaymentRequestTemplateEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function MerchantPaymentRequestTemplateEntity:match_set(args)
  if args ~= nil then
...
function MerchantPaymentRequestTemplateEntity:match_get()
...
function MerchantPaymentRequestTemplateEntity:stream(action, args, callopts)
...
---@param reqmatch MerchantPaymentRequestTemplateLoadMatch
---@param ctrl? table
---@return MerchantPaymentRequestTemplate
---@return string? err
function MerchantPaymentRequestTemplateEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch MerchantPaymentRequestTemplateListMatch
---@param ctrl? table
---@return MerchantPaymentRequestTemplate[]
---@return string? err
function MerchantPaymentRequestTemplateEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata MerchantPaymentRequestTemplateUpdateData
---@param ctrl? table
---@return MerchantPaymentRequestTemplate
---@return string? err
function MerchantPaymentRequestTemplateEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
---@param reqmatch MerchantPaymentRequestTemplateRemoveMatch
---@param ctrl? table
---@return MerchantPaymentRequestTemplate
---@return string? err
function MerchantPaymentRequestTemplateEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
...
function MerchantPaymentRequestTemplateEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return MerchantPaymentRequestTemplateEntity
