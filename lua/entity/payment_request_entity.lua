...
local PaymentRequestEntity = {}
PaymentRequestEntity.__index = PaymentRequestEntity


function PaymentRequestEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, PaymentRequestEntity)
  self._name = "payment_request"
  self._client = client
...
function PaymentRequestEntity:get_name()
  return self._name
end


function PaymentRequestEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return PaymentRequestEntity.new(self._client, opts)
end
...
function PaymentRequestEntity:mark_deleted()
  self._deleted = true
end


function PaymentRequestEntity:deleted()
  return true == self._deleted
end


function PaymentRequestEntity:data_set(args)
  if args ~= nil then
...
function PaymentRequestEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function PaymentRequestEntity:match_set(args)
  if args ~= nil then
...
function PaymentRequestEntity:match_get()
...
function PaymentRequestEntity:stream(action, args, callopts)
...
---@param reqmatch PaymentRequestLoadMatch
---@param ctrl? table
---@return PaymentRequest
---@return string? err
function PaymentRequestEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch PaymentRequestListMatch
---@param ctrl? table
---@return PaymentRequest[]
---@return string? err
function PaymentRequestEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata PaymentRequestCreateData
---@param ctrl? table
---@return PaymentRequest
---@return string? err
function PaymentRequestEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata PaymentRequestUpdateData
---@param ctrl? table
---@return PaymentRequest
---@return string? err
function PaymentRequestEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
---@param reqmatch PaymentRequestRemoveMatch
---@param ctrl? table
---@return PaymentRequest
---@return string? err
function PaymentRequestEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
...
function PaymentRequestEntity:_run_op(ctx, post_done)
  local utility = self._utility
