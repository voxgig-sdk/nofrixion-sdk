-- Nofrixion SDK MerchantPayByBankSetting entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local MerchantPayByBankSettingEntity = {}
MerchantPayByBankSettingEntity.__index = MerchantPayByBankSettingEntity


function MerchantPayByBankSettingEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, MerchantPayByBankSettingEntity)
  self._name = "merchant_pay_by_bank_setting"
  self._client = client
...
function MerchantPayByBankSettingEntity:get_name()
  return self._name
end


function MerchantPayByBankSettingEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return MerchantPayByBankSettingEntity.new(self._client, opts)
end
...
function MerchantPayByBankSettingEntity:mark_deleted()
  self._deleted = true
end


function MerchantPayByBankSettingEntity:deleted()
  return true == self._deleted
end


function MerchantPayByBankSettingEntity:data_set(args)
  if args ~= nil then
...
function MerchantPayByBankSettingEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function MerchantPayByBankSettingEntity:match_set(args)
  if args ~= nil then
...
function MerchantPayByBankSettingEntity:match_get()
...
function MerchantPayByBankSettingEntity:stream(action, args, callopts)
...
---@param reqmatch MerchantPayByBankSettingListMatch
---@param ctrl? table
---@return MerchantPayByBankSetting[]
---@return string? err
function MerchantPayByBankSettingEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function MerchantPayByBankSettingEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return MerchantPayByBankSettingEntity
