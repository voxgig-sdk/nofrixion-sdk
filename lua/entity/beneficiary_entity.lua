...
function BeneficiaryEntity:mark_deleted()
  self._deleted = true
end


function BeneficiaryEntity:deleted()
...
function BeneficiaryEntity:stream(action, args, callopts)
...
---@param reqmatch BeneficiaryListMatch
---@param ctrl? table
---@return Beneficiary[]
---@return string? err
function BeneficiaryEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
