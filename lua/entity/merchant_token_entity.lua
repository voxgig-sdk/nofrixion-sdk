...
local MerchantTokenEntity = {}
MerchantTokenEntity.__index = MerchantTokenEntity


function MerchantTokenEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, MerchantTokenEntity)
  self._name = "merchant_token"
  self._client = client
...
function MerchantTokenEntity:get_name()
  return self._name
end


function MerchantTokenEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return MerchantTokenEntity.new(self._client, opts)
end
...
function MerchantTokenEntity:mark_deleted()
  self._deleted = true
end


function MerchantTokenEntity:deleted()
  return true == self._deleted
end


function MerchantTokenEntity:data_set(args)
  if args ~= nil then
...
function MerchantTokenEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function MerchantTokenEntity:match_set(args)
  if args ~= nil then
...
function MerchantTokenEntity:match_get()
...
function MerchantTokenEntity:stream(action, args, callopts)
...
---@param reqmatch MerchantTokenLoadMatch
---@param ctrl? table
---@return MerchantToken
---@return string? err
function MerchantTokenEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch MerchantTokenListMatch
---@param ctrl? table
---@return MerchantToken[]
---@return string? err
function MerchantTokenEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata MerchantTokenCreateData
---@param ctrl? table
---@return MerchantToken
---@return string? err
function MerchantTokenEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata MerchantTokenUpdateData
---@param ctrl? table
---@return MerchantToken
---@return string? err
function MerchantTokenEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function MerchantTokenEntity:_run_op(ctx, post_done)
  local utility = self._utility
