-- Nofrixion SDK Payeeverification entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local PayeeverificationEntity = {}
PayeeverificationEntity.__index = PayeeverificationEntity


function PayeeverificationEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, PayeeverificationEntity)
  self._name = "payeeverification"
  self._client = client
...
function PayeeverificationEntity:get_name()
  return self._name
end


function PayeeverificationEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return PayeeverificationEntity.new(self._client, opts)
end
...
function PayeeverificationEntity:mark_deleted()
  self._deleted = true
end


function PayeeverificationEntity:deleted()
  return true == self._deleted
end


function PayeeverificationEntity:data_set(args)
  if args ~= nil then
...
function PayeeverificationEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function PayeeverificationEntity:match_set(args)
  if args ~= nil then
...
function PayeeverificationEntity:match_get()
...
function PayeeverificationEntity:stream(action, args, callopts)
...
---@param reqdata PayeeverificationCreateData
---@param ctrl? table
---@return Payeeverification
---@return string? err
function PayeeverificationEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function PayeeverificationEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return PayeeverificationEntity
