...
-- by passing it.
function NofrixionSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function NofrixionSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "NofrixionSDK: graphql: " .. msg
    res.graphql = errors
  end
