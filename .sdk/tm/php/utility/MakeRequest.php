...
// Nofrixion SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class NofrixionMakeRequest
{
    public static function call(NofrixionContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new NofrixionResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new NofrixionResponse($fetched);
        } else {
