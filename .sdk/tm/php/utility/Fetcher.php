...
// Nofrixion SDK utility: fetcher

class NofrixionFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; NofrixionSDK/1.0)';
    ...
    public static function call(NofrixionContext $ctx, string $fullurl, array $fetchdef): array
    {
