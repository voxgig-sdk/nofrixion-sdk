...
class NofrixionGraphql
{
    ...
    // equivalent.
    public static function body(NofrixionContext $ctx): mixed
    {
    ...
    public static function errors(NofrixionContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
