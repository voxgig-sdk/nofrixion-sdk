...
// Nofrixion SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class NofrixionTransformResponse
{
    public static function call(NofrixionContext $ctx): mixed
    {
        ...
        $transform = NofrixionHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
