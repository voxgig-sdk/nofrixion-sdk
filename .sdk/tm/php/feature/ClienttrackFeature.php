...
// Nofrixion SDK clienttrack feature
...
class NofrixionClienttrackFeature extends NofrixionBaseFeature
{
    ...
    public function PostConstruct(NofrixionContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Nofrixion-SDK';
