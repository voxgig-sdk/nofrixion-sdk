...
class NofrixionProxyFeature extends NofrixionBaseFeature
{
    ...
    public function init(NofrixionContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (NofrixionContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
