...
|---|---|---|
| `ts/` | @voxgig-sdk/nofrixion | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/nofrixion \
      --repository voxgig-sdk/nofrixion-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/nofrixion` shows it, and
`npm trust revoke @voxgig-sdk/nofrixion --id=<id>` removes it.
