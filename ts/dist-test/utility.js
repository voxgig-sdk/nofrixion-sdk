...
function envOverride(m) {
    if ('TRUE' === process.env.NOFRIXION_TEST_LIVE ||
        'TRUE' === process.env.NOFRIXION_TEST_OVERRIDE) {
    ...
    m.NOFRIXION_TEST_EXPLAIN = process.env.NOFRIXION_TEST_EXPLAIN || m.NOFRIXION_TEST_EXPLAIN;
    return m;
}
