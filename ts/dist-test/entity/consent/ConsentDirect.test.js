...
(0, node_test_1.describe)('ConsentDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-consent', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-consent', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-consent', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-consent', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["email01", "merchant01"]))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['NOFRIXION_TEST_CONSENT_ENTID'];
...
//# sourceMappingURL=ConsentDirect.test.js.map