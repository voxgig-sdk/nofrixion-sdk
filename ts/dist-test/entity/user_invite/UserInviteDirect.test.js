...
(0, node_test_1.describe)('UserInviteDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-user_invite', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-user_invite', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-user_invite', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-user_invite', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['NOFRIXION_TEST_USER_INVITE_ENTID'];
...
//# sourceMappingURL=UserInviteDirect.test.js.map