...
(0, node_test_1.describe)('PaymentRequestResultDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-payment_request_result', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-payment_request_result', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['NOFRIXION_TEST_PAYMENT_REQUEST_RESULT_ENTID'];
...
//# sourceMappingURL=PaymentRequestResultDirect.test.js.map