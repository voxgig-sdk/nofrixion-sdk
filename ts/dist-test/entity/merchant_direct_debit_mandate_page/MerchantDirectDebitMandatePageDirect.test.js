...
(0, node_test_1.describe)('MerchantDirectDebitMandatePageDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-merchant_direct_debit_mandate_page', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-merchant_direct_debit_mandate_page', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['NOFRIXION_TEST_MERCHANT_DIRECT_DEBIT_MANDATE_PAGE_ENTID'];
...
//# sourceMappingURL=MerchantDirectDebitMandatePageDirect.test.js.map