...
(0, node_test_1.describe)('CardPublicKeyDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-card_public_key', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-card_public_key', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["paymentrequest_id01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['NOFRIXION_TEST_CARD_PUBLIC_KEY_ENTID'];
...
//# sourceMappingURL=CardPublicKeyDirect.test.js.map