...
(0, node_test_1.describe)('CardPublicKeyEntity', async () => {
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/card_public_key/CardPublicKeyTestData.json');
    ...
    let idmap = transform(['card_public_key01', 'card_public_key02', 'card_public_key03', 'paymentrequest01', 'paymentrequest02', 'paymentrequest03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    idmap = env['NOFRIXION_TEST_CARD_PUBLIC_KEY_ENTID'];
...
//# sourceMappingURL=CardPublicKeyEntity.test.js.map