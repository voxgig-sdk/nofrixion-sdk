...
(0, node_test_1.describe)('MerchantPayByBankSettingDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-merchant_pay_by_bank_setting', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-merchant_pay_by_bank_setting', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['NOFRIXION_TEST_MERCHANT_PAY_BY_BANK_SETTING_ENTID'];
...
//# sourceMappingURL=MerchantPayByBankSettingDirect.test.js.map