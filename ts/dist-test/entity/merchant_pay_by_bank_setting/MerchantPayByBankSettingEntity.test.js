...
(0, node_test_1.describe)('MerchantPayByBankSettingEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['list']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'merchant_pay_by_bank_setting.' + op, live))
                return;
        }
...
function basicSetup(extra) {
    ...
    const idmapEnvVal = process.env['NOFRIXION_TEST_MERCHANT_PAY_BY_BANK_SETTING_ENTID'];
