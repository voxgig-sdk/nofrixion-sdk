...
function basicSetup(extra) {
    ...
    let idmap = transform(['merchant01', 'merchant02', 'merchant03', 'merchant01', 'merchant02', 'merchant03', 'user01', 'user02', 'user03', 'merchant01', 'merchant02', 'merchant03', 'tag01', 'tag02', 'tag03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['NOFRIXION_TEST_MERCHANT_ENTID'];
    ...
    idmap = env['NOFRIXION_TEST_MERCHANT_ENTID'];
