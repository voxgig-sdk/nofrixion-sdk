...
(0, node_test_1.describe)('RuleEventDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-rule_event', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-rule_event', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["rule_event01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['NOFRIXION_TEST_RULE_EVENT_ENTID'];
...
//# sourceMappingURL=RuleEventDirect.test.js.map