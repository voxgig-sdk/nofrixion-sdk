...
(0, node_test_1.describe)('PaymentRequestEventDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-payment_request_event', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-payment_request_event', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['NOFRIXION_TEST_PAYMENT_REQUEST_EVENT_ENTID'];
...
//# sourceMappingURL=PaymentRequestEventDirect.test.js.map