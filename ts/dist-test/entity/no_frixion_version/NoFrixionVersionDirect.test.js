...
(0, node_test_1.describe)('NoFrixionVersionDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-no_frixion_version', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-no_frixion_version', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['NOFRIXION_TEST_NO_FRIXION_VERSION_ENTID'];
...
//# sourceMappingURL=NoFrixionVersionDirect.test.js.map