...
(0, node_test_1.describe)('BeneficiaryGroupEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['list']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'beneficiary_group.' + op, live))
                return;
        }
        ...
        let beneficiary_group_ref01_data = Object.values(setup.data.existing.beneficiary_group)[0];
        // LIST
        const beneficiary_group_ref01_ent = client.BeneficiaryGroup();
        const beneficiary_group_ref01_match = {};
        beneficiary_group_ref01_match['merchant_id'] = setup.idmap['merchant01'];
        const beneficiary_group_ref01_list = (await beneficiary_group_ref01_ent.list(beneficiary_group_ref01_match)).map((e) => e.data());
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/beneficiary_group/BeneficiaryGroupTestData.json');
    ...
    let idmap = transform(['beneficiary_group01', 'beneficiary_group02', 'beneficiary_group03', 'merchant01', 'merchant02', 'merchant03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=BeneficiaryGroupEntity.test.js.map