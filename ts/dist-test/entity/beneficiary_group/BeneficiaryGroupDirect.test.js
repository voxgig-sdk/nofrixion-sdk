...
(0, node_test_1.describe)('BeneficiaryGroupDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-beneficiary_group', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-beneficiary_group', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['NOFRIXION_TEST_BENEFICIARY_GROUP_ENTID'];
...
//# sourceMappingURL=BeneficiaryGroupDirect.test.js.map