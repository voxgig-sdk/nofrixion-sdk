...
function basicSetup(extra) {
    ...
    let idmap = transform(['account01', 'account02', 'account03', 'account01', 'account02', 'account03', 'merchant01', 'merchant02', 'merchant03', 'account01', 'account02', 'account03', 'topup01', 'topup02', 'topup03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
