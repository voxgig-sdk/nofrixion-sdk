...
(0, node_test_1.describe)('ReportResultDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-report_result', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-report_result', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["id01", "report_id01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['NOFRIXION_TEST_REPORT_RESULT_ENTID'];
...
//# sourceMappingURL=ReportResultDirect.test.js.map