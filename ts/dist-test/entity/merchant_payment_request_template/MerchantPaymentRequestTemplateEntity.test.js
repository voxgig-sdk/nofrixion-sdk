...
(0, node_test_1.describe)('MerchantPaymentRequestTemplateEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['list', 'update', 'load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'merchant_payment_request_template.' + op, live))
                return;
        }
        ...
        let merchant_payment_request_template_ref01_data = Object.values(setup.data.existing.merchant_payment_request_template)[0];
        // LIST
        const merchant_payment_request_template_ref01_ent = client.MerchantPaymentRequestTemplate();
        const merchant_payment_request_template_ref01_match = {};
        merchant_payment_request_template_ref01_match['merchant_id'] = setup.idmap['merchant01'];
        const merchant_payment_request_template_ref01_list = (await merchant_payment_request_template_ref01_ent.list(merchant_payment_request_template_ref01_match)).map((e) => e.data());
        // UPDATE
        const merchant_payment_request_template_ref01_data_up0 = {};
        ...
        merchant_payment_request_template_ref01_data_up0[merchant_payment_request_template_ref01_markdef_up0.name] = merchant_payment_request_template_ref01_markdef_up0.value;
        ...
        (0, node_assert_1.default)(merchant_payment_request_template_ref01_resdata_up0.id === merchant_payment_request_template_ref01_data_up0.id);
        (0, node_assert_1.default)(merchant_payment_request_template_ref01_resdata_up0[merchant_payment_request_template_ref01_markdef_up0.name] === merchant_payment_request_template_ref01_markdef_up0.value);
        // LOAD
        const merchant_payment_request_template_ref01_match_dt0 = {};
        ...
        (0, node_assert_1.default)(merchant_payment_request_template_ref01_data_dt0.id === merchant_payment_request_template_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/merchant_payment_request_template/MerchantPaymentRequestTemplateTestData.json');
    ...
    let idmap = transform(['merchant_payment_request_template01', 'merchant_payment_request_template02', 'merchant_payment_request_template03', 'paymentrequest01', 'paymentrequest02', 'paymentrequest03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=MerchantPaymentRequestTemplateEntity.test.js.map