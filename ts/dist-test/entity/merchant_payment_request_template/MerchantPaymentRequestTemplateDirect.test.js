...
(0, node_test_1.describe)('MerchantPaymentRequestTemplateDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-merchant_payment_request_template', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-merchant_payment_request_template', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["paymentrequest01"]))
            return;
    ...
    (0, node_test_1.test)('direct-list-merchant_payment_request_template', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-merchant_payment_request_template', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["merchant01"]))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['NOFRIXION_TEST_MERCHANT_PAYMENT_REQUEST_TEMPLATE_ENTID'];
...
//# sourceMappingURL=MerchantPaymentRequestTemplateDirect.test.js.map