...
(0, node_test_1.describe)('VirtualEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        // CREATE
        const virtual_ref01_ent = client.Virtual();
        ...
        (0, node_assert_1.default)(null != virtual_ref01_data.id);
        // UPDATE
        const virtual_ref01_data_up0 = {};
        ...
        virtual_ref01_data_up0[virtual_ref01_markdef_up0.name] = virtual_ref01_markdef_up0.value;
        const virtual_ref01_resdata_up0 = (await virtual_ref01_ent.update(virtual_ref01_data_up0)).data();
        (0, node_assert_1.default)(virtual_ref01_resdata_up0.id === virtual_ref01_data_up0.id);
        (0, node_assert_1.default)(virtual_ref01_resdata_up0[virtual_ref01_markdef_up0.name] === virtual_ref01_markdef_up0.value);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/virtual/VirtualTestData.json');
    ...
    let idmap = transform(['virtual01', 'virtual02', 'virtual03', 'account01', 'account02', 'account03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['NOFRIXION_TEST_VIRTUAL_ENTID'];
    ...
    idmap = env['NOFRIXION_TEST_VIRTUAL_ENTID'];
...
//# sourceMappingURL=VirtualEntity.test.js.map