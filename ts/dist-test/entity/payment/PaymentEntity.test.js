...
(0, node_test_1.describe)('PaymentEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        (0, node_assert_1.default)(null != payment_ref01_data.id);
        // UPDATE
        const payment_ref01_data_up0 = {};
        ...
        payment_ref01_data_up0[payment_ref01_markdef_up0.name] = payment_ref01_markdef_up0.value;
        const payment_ref01_resdata_up0 = (await payment_ref01_ent.update(payment_ref01_data_up0)).data();
        (0, node_assert_1.default)(payment_ref01_resdata_up0.id === payment_ref01_data_up0.id);
        (0, node_assert_1.default)(payment_ref01_resdata_up0[payment_ref01_markdef_up0.name] === payment_ref01_markdef_up0.value);
        // LOAD
        ...
        (0, node_assert_1.default)(payment_ref01_data_dt0.id === payment_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    let idmap = transform(['payment01', 'payment02', 'payment03', 'getbyorderid01', 'getbyorderid02', 'getbyorderid03', 'paymentrequest01', 'paymentrequest02', 'paymentrequest03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['NOFRIXION_TEST_PAYMENT_ENTID'];
    ...
    idmap = env['NOFRIXION_TEST_PAYMENT_ENTID'];
