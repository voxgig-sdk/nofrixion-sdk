...
(0, node_test_1.describe)('PayoutMetricEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        let payout_metric_ref01_data = Object.values(setup.data.existing.payout_metric)[0];
        // LOAD
        const payout_metric_ref01_ent = client.PayoutMetric();
        const payout_metric_ref01_match_dt0 = {};
        const payout_metric_ref01_data_dt0 = (await payout_metric_ref01_ent.load(payout_metric_ref01_match_dt0)).data();
        (0, node_assert_1.default)(null != payout_metric_ref01_data_dt0);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/payout_metric/PayoutMetricTestData.json');
    ...
    let idmap = transform(['payout_metric01', 'payout_metric02', 'payout_metric03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=PayoutMetricEntity.test.js.map