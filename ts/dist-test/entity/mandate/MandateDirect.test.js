...
(0, node_test_1.describe)('MandateDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-mandate', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-mandate', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['NOFRIXION_TEST_MANDATE_ENTID'];
...
//# sourceMappingURL=MandateDirect.test.js.map