...
(0, node_test_1.describe)('BeneficiaryDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-beneficiary', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-beneficiary', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-beneficiary', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-beneficiary', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['NOFRIXION_TEST_BENEFICIARY_ENTID'];
...
//# sourceMappingURL=BeneficiaryDirect.test.js.map