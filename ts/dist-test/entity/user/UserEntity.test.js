...
(0, node_test_1.describe)('UserEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        if (setup.syntheticOnly) {
            t.skip('live entity test uses synthetic IDs from fixture — set NOFRIXION_TEST_USER_ENTID JSON to run live');
            return;
        }
...
function basicSetup(extra) {
    ...
    let idmap = transform(['user01', 'user02', 'user03', 'merchant01', 'merchant02', 'merchant03', 'user01', 'user02', 'user03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['NOFRIXION_TEST_USER_ENTID'];
    ...
    idmap = env['NOFRIXION_TEST_USER_ENTID'];
