...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/open_banking/OpenBankingTestData.json');
    ...
    let idmap = transform(['open_banking01', 'open_banking02', 'open_banking03', 'account01', 'account02', 'account03', 'consent01', 'consent02', 'consent03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=OpenBankingEntity.test.js.map