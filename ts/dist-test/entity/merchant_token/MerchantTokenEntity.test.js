...
(0, node_test_1.describe)('MerchantTokenEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create', 'list', 'update', 'load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'merchant_token.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != merchant_token_ref01_data.id);
        // LIST
        const merchant_token_ref01_match = {};
        merchant_token_ref01_match['merchant_id'] = setup.idmap['merchant01'];
        const merchant_token_ref01_list = (await merchant_token_ref01_ent.list(merchant_token_ref01_match)).map((e) => e.data());
        (0, node_assert_1.default)(!isempty(select(merchant_token_ref01_list, { id: merchant_token_ref01_data.id })));
        // UPDATE
        const merchant_token_ref01_data_up0 = {};
        ...
        merchant_token_ref01_data_up0[merchant_token_ref01_markdef_up0.name] = merchant_token_ref01_markdef_up0.value;
        const merchant_token_ref01_resdata_up0 = (await merchant_token_ref01_ent.update(merchant_token_ref01_data_up0)).data();
        (0, node_assert_1.default)(merchant_token_ref01_resdata_up0.id === merchant_token_ref01_data_up0.id);
        (0, node_assert_1.default)(merchant_token_ref01_resdata_up0[merchant_token_ref01_markdef_up0.name] === merchant_token_ref01_markdef_up0.value);
        // LOAD
        const merchant_token_ref01_match_dt0 = {};
        ...
        (0, node_assert_1.default)(merchant_token_ref01_data_dt0.id === merchant_token_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/merchant_token/MerchantTokenTestData.json');
    ...
    let idmap = transform(['merchant_token01', 'merchant_token02', 'merchant_token03', 'merchant01', 'merchant02', 'merchant03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=MerchantTokenEntity.test.js.map