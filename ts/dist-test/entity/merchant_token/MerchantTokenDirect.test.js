...
(0, node_test_1.describe)('MerchantTokenDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-merchant_token', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-merchant_token', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-merchant_token', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-merchant_token', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    const env = (0, utility_1.envOverride)({
        'NOFRIXION_TEST_MERCHANT_TOKEN_ENTID': {},
    ...
    if (live) {
        ...
        let idmap = env['NOFRIXION_TEST_MERCHANT_TOKEN_ENTID'];
...
//# sourceMappingURL=MerchantTokenDirect.test.js.map