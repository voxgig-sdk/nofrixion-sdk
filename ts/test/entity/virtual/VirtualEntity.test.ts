...
describe('VirtualEntity', async () => {
  ...
  test('basic', async (t) => {
    ...
    for (const op of ['create', 'update']) {
      if (maybeSkipControl(t, 'entityOp', 'virtual.' + op, live)) return
    }
    ...
    // UPDATE
    const virtual_ref01_data_up0: any = {}
...
function basicSetup(extra?: any) {
  ...
  const entityDataFile =
    Path.resolve(__dirname, 
      '../../../../.sdk/test/entity/virtual/VirtualTestData.json')
