...
describe('CardCustomerTokenEntity', async () => {
  ...
  test('basic', async (t) => {
    ...
    let card_customer_token_ref01_data = Object.values(setup.data.existing.card_customer_token)[0] as any

    // LIST
    const card_customer_token_ref01_ent = client.CardCustomerToken()
    const card_customer_token_ref01_match: any = {}
...
function basicSetup(extra?: any) {
  ...
  const entityDataFile =
    Path.resolve(__dirname, 
      '../../../../.sdk/test/entity/card_customer_token/CardCustomerTokenTestData.json')
  ...
  let idmap = transform(
    ['card_customer_token01','card_customer_token02','card_customer_token03','removeall01','removeall02','removeall03','customertoken01','customertoken02','customertoken03'],
    {
      '`$PACK`': ['', {
        '`$KEY`': '`$COPY`',
