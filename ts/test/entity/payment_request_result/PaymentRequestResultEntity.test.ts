...
describe('PaymentRequestResultEntity', async () => {
  ...
  test('basic', async (t) => {
    ...
    for (const op of ['list']) {
      if (maybeSkipControl(t, 'entityOp', 'payment_request_result.' + op, live)) return
    }
    ...
    const payment_request_result_ref01_list = await payment_request_result_ref01_ent.list(payment_request_result_ref01_match)
