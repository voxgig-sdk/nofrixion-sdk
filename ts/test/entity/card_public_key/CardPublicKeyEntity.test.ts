...
describe('CardPublicKeyEntity', async () => {
  ...
  test('basic', async (t) => {
    ...
    let card_public_key_ref01_data = Object.values(setup.data.existing.card_public_key)[0] as any
...
function basicSetup(extra?: any) {
  ...
  const entityDataFile =
    Path.resolve(__dirname, 
      '../../../../.sdk/test/entity/card_public_key/CardPublicKeyTestData.json')
