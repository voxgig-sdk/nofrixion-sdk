...
class TransactionEntity extends NofrixionEntityBase<Transaction> {
  ...
  async remove(
    this: any, reqmatch?: TransactionRemoveMatch, ctrl?: Control,
    ...
    try {
      ...
      if (err) {
        ...
        // Off-happy-path (throw disabled): typed as any so the method's
        // Promise<TransactionEntity> return stays clean under strict null checks.
        return undefined as any
      }
    }
  }
