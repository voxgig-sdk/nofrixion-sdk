...
import type {
  OpenBanking,
  OpenBankingCreateData,
  OpenBankingRemoveMatch,
} from '../NofrixionTypes'

// TODO: needs Entity superclass
class OpenBankingEntity extends NofrixionEntityBase<OpenBanking> {

  constructor(client: NofrixionSDK, entopts: any) {
    super(client, entopts)
    this.name = 'open_banking'
    this.name_ = 'open_banking'
    this.Name = 'OpenBanking'
  }


  make(this: OpenBankingEntity) {
    return new OpenBankingEntity(this._client, this.entopts())
  }
  ...
  async create(this: any, reqdata?: OpenBankingCreateData, ctrl?: Control): Promise<OpenBankingEntity> {
    ...
    try {
      ...
      if (err) {
        ...
        // Promise<OpenBanking> return stays clean under strict null checks.
  ...
  async remove(
    this: any, reqmatch?: OpenBankingRemoveMatch, ctrl?: Control,
  ): Promise<OpenBankingEntity> {
    ...
    try {
      ...
      if (err) {
        ...
        // Off-happy-path (throw disabled): typed as any so the method's
        // Promise<OpenBankingEntity> return stays clean under strict null checks.
        return undefined as any
      }
    }
  }
