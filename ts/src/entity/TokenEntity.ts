...
class TokenEntity extends NofrixionEntityBase<Token> {
  ...
  async create(this: any, reqdata?: TokenCreateData, ctrl?: Control): Promise<TokenEntity> {
    ...
    try {
      ...
      if (err) {
        ...
        // Promise<Token> return stays clean under strict null checks.
  ...
  async remove(
    this: any, reqmatch?: TokenRemoveMatch, ctrl?: Control,
  ): Promise<TokenEntity> {
    ...
    try {
      ...
      if (err) {
        ...
        // Off-happy-path (throw disabled): typed as any so the method's
        // Promise<TokenEntity> return stays clean under strict null checks.
        return undefined as any
      }
    }
  }
