...
class TestPayrunEntity:
    ...
    def test_should_stream(self):
        ...
        seen = list(base.Payrun(None).stream("list", None, None))
        assert len(seen) == 3
        ...
        if isinstance(cfg.get("feature"), dict) and "streaming" in cfg["feature"]:
            ...
            got = []
            for item in sdk.Payrun(None).stream("list", None, None):
    ...
    def test_should_run_basic_flow(self):
        ...
        payrun_ref01_data = helpers.to_map(runner.entity_data(payrun_ref01_ent.create(payrun_ref01_data, None)))
        ...
        payrun_ref01_list_result = payrun_ref01_ent.list(payrun_ref01_match, None)
        assert isinstance(payrun_ref01_list_result, list)
        ...
        payrun_ref01_resdata_up0 = helpers.to_map(runner.entity_data(payrun_ref01_ent.update(payrun_ref01_data_up0_up, None)))
        ...
        payrun_ref01_data_dt0_loaded = payrun_ref01_ent.load(payrun_ref01_match_dt0, None)
        payrun_ref01_data_dt0_load_result = helpers.to_map(runner.entity_data(payrun_ref01_data_dt0_loaded))
        assert payrun_ref01_data_dt0_load_result is not None
        assert payrun_ref01_data_dt0_load_result["id"] == payrun_ref01_data["id"]
        ...
        payrun_ref01_list_rt0_result = payrun_ref01_ent.list(payrun_ref01_match_rt0, None)
        assert isinstance(payrun_ref01_list_rt0_result, list)
