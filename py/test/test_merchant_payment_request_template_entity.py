...
class TestMerchantPaymentRequestTemplateEntity:
    ...
    def test_should_run_basic_flow(self):
        ...
        merchant_payment_request_template_ref01_resdata_up0 = helpers.to_map(runner.entity_data(merchant_payment_request_template_ref01_ent.update(merchant_payment_request_template_ref01_data_up0_up, None)))
        ...
        merchant_payment_request_template_ref01_data_dt0_load_result = helpers.to_map(runner.entity_data(merchant_payment_request_template_ref01_data_dt0_loaded))
