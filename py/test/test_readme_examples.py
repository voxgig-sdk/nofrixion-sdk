# Nofrixion SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions NofrixionSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both NofrixionSDK(...) and NofrixionSDK.test(...) become
#      NofrixionSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "nofrixion_sdk"
_SDK_CLASS = "NofrixionSDK"
...
_ENTITIES = {
    "Account": "account",
    "Batch": "batch",
    "BeneficiariesCreate": "beneficiaries_create",
    "Beneficiary": "beneficiary",
    "BeneficiaryGroup": "beneficiary_group",
    "Card": "card",
    "CardCustomerToken": "card_customer_token",
    "CardPayment": "card_payment",
    "CardPublicKey": "card_public_key",
    "Consent": "consent",
    "Currency": "currency",
    "DirectDebitBatchSubmit": "direct_debit_batch_submit",
    "FxRate": "fx_rate",
    "IPayment": "i_payment",
    "Mandate": "mandate",
    "Merchant": "merchant",
    "MerchantAuthorisationSetting": "merchant_authorisation_setting",
    "MerchantDirectDebitMandate": "merchant_direct_debit_mandate",
    "MerchantPayByBankSetting": "merchant_pay_by_bank_setting",
    "MerchantPaymentRequestTemplate": "merchant_payment_request_template",
    "MerchantToken": "merchant_token",
    "Metadata": "metadata",
    "NoFrixionVersion": "no_frixion_version",
    "OpenBanking": "open_banking",
    "Payeeverification": "payeeverification",
    "Payment": "payment",
    "PaymentAccount": "payment_account",
    "PaymentAccountMinimal": "payment_account_minimal",
    "PaymentInitiation": "payment_initiation",
    "PaymentRequest": "payment_request",
    "PaymentRequestEvent": "payment_request_event",
    "PaymentRequestMetric": "payment_request_metric",
    "PaymentRequestMinimal": "payment_request_minimal",
    "PaymentRequestResult": "payment_request_result",
    "PaymentRequestsCreate": "payment_requests_create",
    "Payout": "payout",
    "PayoutKeyset": "payout_keyset",
    "PayoutMetric": "payout_metric",
    ...
    "UserInvitesCreate": "user_invites_create",
    "Virtual": "virtual",
    "Webhook": "webhook",
}
