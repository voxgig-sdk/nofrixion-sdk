    ...
    def test_should_run_basic_flow(self):
        ...
        if setup.get("synthetic_only"):
            pytest.skip("live entity test uses synthetic IDs from fixture — "
                        "set NOFRIXION_TEST_ENABLE_ENTID JSON to run live")
        client = setup["client"]
        ...
        # UPDATE
        enable_ref01_ent = client.Enable(None)
        enable_ref01_data_up0_up = {
            "id": enable_ref01_data["id"],
        }

        enable_ref01_markdef_up0_name = "approval_callback_url"
        enable_ref01_markdef_up0_value = "Mark01-enable_ref01_" + str(setup["now"])
        ...
        assert enable_ref01_resdata_up0["id"] == enable_ref01_data_up0_up["id"]
        assert enable_ref01_resdata_up0[enable_ref01_markdef_up0_name] == enable_ref01_markdef_up0_value
...
def _enable_basic_setup(extra):
    ...
    idmap_resolved = helpers.to_map(
        env.get("NOFRIXION_TEST_ENABLE_ENTID"))
