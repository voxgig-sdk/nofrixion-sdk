...
from nofrixion_sdk.nofrixion_types import (
...
class MerchantPaymentRequestTemplateEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return MerchantPaymentRequestTemplateEntity(self._client, opts)
    ...
    def data_get(self) -> MerchantPaymentRequestTemplate:
    ...
    def match_get(self) -> MerchantPaymentRequestTemplate:
    ...
    def load(self, reqmatch=None, ctrl=None) -> MerchantPaymentRequestTemplate:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.MerchantPaymentRequestTemplate().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[MerchantPaymentRequestTemplate]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.MerchantPaymentRequestTemplate().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
        ctx = utility.make_context({
            "opname": "list",
    ...
    def update(self, reqdata: MerchantPaymentRequestTemplateUpdateData, ctrl=None) -> MerchantPaymentRequestTemplate:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "update",
            "ctrl": ctrl,
    ...
    def remove(self, reqmatch=None, ctrl=None) -> MerchantPaymentRequestTemplate:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key removes with no
        # match. Treat None as an empty match so client.MerchantPaymentRequestTemplate().remove()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
        ctx = utility.make_context({
