...
class PaymentRequestResultEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return PaymentRequestResultEntity(self._client, opts)
    ...
    def data_get(self) -> PaymentRequestResult:
    ...
    def match_get(self) -> PaymentRequestResult:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[PaymentRequestResult]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.PaymentRequestResult().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
