...
class PaymentInitiationEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return PaymentInitiationEntity(self._client, opts)
    ...
    def data_get(self) -> PaymentInitiation:
    ...
    def match_get(self) -> PaymentInitiation:
    ...
    def create(self, reqdata: PaymentInitiationCreateData, ctrl=None) -> PaymentInitiation:
        utility = self._utility
