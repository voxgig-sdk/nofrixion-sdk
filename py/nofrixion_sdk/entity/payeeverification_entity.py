...
class PayeeverificationEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return PayeeverificationEntity(self._client, opts)
    ...
    def data_get(self) -> Payeeverification:
    ...
    def match_get(self) -> Payeeverification:
    ...
    def create(self, reqdata: PayeeverificationCreateData, ctrl=None) -> Payeeverification:
        utility = self._utility
