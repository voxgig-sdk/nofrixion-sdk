...
class PaymentAccountMinimalEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return PaymentAccountMinimalEntity(self._client, opts)
    ...
    def data_get(self) -> PaymentAccountMinimal:
    ...
    def match_get(self) -> PaymentAccountMinimal:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[PaymentAccountMinimal]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.PaymentAccountMinimal().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
