...
class DirectDebitBatchSubmitEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return DirectDebitBatchSubmitEntity(self._client, opts)
    ...
    def data_get(self) -> DirectDebitBatchSubmit:
    ...
    def match_get(self) -> DirectDebitBatchSubmit:
    ...
    def create(self, reqdata: DirectDebitBatchSubmitCreateData, ctrl=None) -> DirectDebitBatchSubmit:
        utility = self._utility
