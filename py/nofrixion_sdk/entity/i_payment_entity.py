...
class IPaymentEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return IPaymentEntity(self._client, opts)
    ...
    def create(self, reqdata: IPaymentCreateData, ctrl=None) -> IPayment:
        utility = self._utility
