...
class PaymentAccountEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return PaymentAccountEntity(self._client, opts)
    ...
    def data_get(self) -> PaymentAccount:
    ...
    def match_get(self) -> PaymentAccount:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[PaymentAccount]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.PaymentAccount().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
