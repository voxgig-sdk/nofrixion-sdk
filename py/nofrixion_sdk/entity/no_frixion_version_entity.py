...
class NoFrixionVersionEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return NoFrixionVersionEntity(self._client, opts)
    ...
    def data_get(self) -> NoFrixionVersion:
    ...
    def match_get(self) -> NoFrixionVersion:
    ...
    def load(self, reqmatch=None, ctrl=None) -> NoFrixionVersion:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.NoFrixionVersion().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
