...
from nofrixion_sdk.nofrixion_types import (
    ...
    MerchantAuthorisationSettingListMatch,
)
...
class MerchantAuthorisationSettingEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return MerchantAuthorisationSettingEntity(self._client, opts)
    ...
    def data_get(self) -> MerchantAuthorisationSetting:
    ...
    def match_get(self) -> MerchantAuthorisationSetting:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[MerchantAuthorisationSetting]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.MerchantAuthorisationSetting().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
