...
class PaymentRequestMetricEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return PaymentRequestMetricEntity(self._client, opts)
    ...
    def data_get(self) -> PaymentRequestMetric:
    ...
    def match_get(self) -> PaymentRequestMetric:
    ...
    def load(self, reqmatch=None, ctrl=None) -> PaymentRequestMetric:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.PaymentRequestMetric().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
