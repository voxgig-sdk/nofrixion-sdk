...
class PaymentRequestEventEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return PaymentRequestEventEntity(self._client, opts)
    ...
    def data_get(self) -> PaymentRequestEvent:
    ...
    def match_get(self) -> PaymentRequestEvent:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[PaymentRequestEvent]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.PaymentRequestEvent().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
