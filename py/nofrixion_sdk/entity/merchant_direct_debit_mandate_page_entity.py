...
from nofrixion_sdk.nofrixion_types import (
    ...
    MerchantDirectDebitMandatePageListMatch,
)
...
class MerchantDirectDebitMandatePageEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return MerchantDirectDebitMandatePageEntity(self._client, opts)
    ...
    def data_get(self) -> MerchantDirectDebitMandatePage:
    ...
    def match_get(self) -> MerchantDirectDebitMandatePage:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[MerchantDirectDebitMandatePage]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.MerchantDirectDebitMandatePage().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
