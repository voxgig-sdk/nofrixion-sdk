...
class PayoutKeysetPageEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return PayoutKeysetPageEntity(self._client, opts)
    ...
    def data_get(self) -> PayoutKeysetPage:
    ...
    def match_get(self) -> PayoutKeysetPage:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[PayoutKeysetPage]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.PayoutKeysetPage().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
