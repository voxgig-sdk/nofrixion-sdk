...
class MerchantTokenEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return MerchantTokenEntity(self._client, opts)
    ...
    def data_get(self) -> MerchantToken:
    ...
    def match_get(self) -> MerchantToken:
    ...
    def load(self, reqmatch=None, ctrl=None) -> MerchantToken:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.MerchantToken().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[MerchantToken]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.MerchantToken().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
        ctx = utility.make_context({
            "opname": "list",
    ...
    def create(self, reqdata: MerchantTokenCreateData, ctrl=None) -> MerchantToken:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "create",
            "ctrl": ctrl,
    ...
    def update(self, reqdata: MerchantTokenUpdateData, ctrl=None) -> MerchantToken:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "update",
            "ctrl": ctrl,
