...
class BeneficiaryGroupEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return BeneficiaryGroupEntity(self._client, opts)
    ...
    def data_get(self) -> BeneficiaryGroup:
    ...
    def match_get(self) -> BeneficiaryGroup:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[BeneficiaryGroup]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.BeneficiaryGroup().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
