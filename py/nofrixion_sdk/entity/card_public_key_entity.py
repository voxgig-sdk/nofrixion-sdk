...
class CardPublicKeyEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return CardPublicKeyEntity(self._client, opts)
    ...
    def data_get(self) -> CardPublicKey:
    ...
    def match_get(self) -> CardPublicKey:
    ...
    def load(self, reqmatch=None, ctrl=None) -> CardPublicKey:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.CardPublicKey().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
