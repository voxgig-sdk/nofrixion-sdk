...
class CardPaymentEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return CardPaymentEntity(self._client, opts)
    ...
    def match_get(self) -> CardPayment:
    ...
    def create(self, reqdata: CardPaymentCreateData, ctrl=None) -> CardPayment:
        utility = self._utility
