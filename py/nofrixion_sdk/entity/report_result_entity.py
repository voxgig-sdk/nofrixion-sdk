...
class ReportResultEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ReportResultEntity(self._client, opts)
    ...
    def data_get(self) -> ReportResult:
    ...
    def match_get(self) -> ReportResult:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ReportResult:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ReportResult().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
