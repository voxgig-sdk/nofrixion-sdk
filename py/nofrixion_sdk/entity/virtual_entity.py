...
class VirtualEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return VirtualEntity(self._client, opts)
    ...
    def create(self, reqdata: VirtualCreateData, ctrl=None) -> Virtual:
        utility = self._utility
    ...
    def update(self, reqdata: VirtualUpdateData, ctrl=None) -> Virtual:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "update",
            "ctrl": ctrl,
