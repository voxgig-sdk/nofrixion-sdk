...
from nofrixion_sdk.nofrixion_types import (
    ...
    MerchantPayByBankSettingListMatch,
)
...
class MerchantPayByBankSettingEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return MerchantPayByBankSettingEntity(self._client, opts)
    ...
    def data_get(self) -> MerchantPayByBankSetting:
    ...
    def match_get(self) -> MerchantPayByBankSetting:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[MerchantPayByBankSetting]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.MerchantPayByBankSetting().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
