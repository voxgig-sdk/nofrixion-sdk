...
from nofrixion_sdk.nofrixion_types import (
    ...
    PaymentRequestMinimalListMatch,
)
...
class PaymentRequestMinimalEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return PaymentRequestMinimalEntity(self._client, opts)
    ...
    def data_get(self) -> PaymentRequestMinimal:
    ...
    def match_get(self) -> PaymentRequestMinimal:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[PaymentRequestMinimal]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.PaymentRequestMinimal().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
