...
class CardCustomerTokenEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return CardCustomerTokenEntity(self._client, opts)
    ...
    def data_get(self) -> CardCustomerToken:
    ...
    def match_get(self) -> CardCustomerToken:
    ...
    def load(self, reqmatch=None, ctrl=None) -> CardCustomerToken:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.CardCustomerToken().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[CardCustomerToken]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.CardCustomerToken().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
        ctx = utility.make_context({
            "opname": "list",
    ...
    def remove(self, reqmatch=None, ctrl=None) -> CardCustomerToken:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key removes with no
        # match. Treat None as an empty match so client.CardCustomerToken().remove()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
        ctx = utility.make_context({
