...
from nofrixion_sdk.core.control import NofrixionControl
...
from nofrixion_sdk.core.helpers import get_ctx_prop, to_map
...
class NofrixionContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, NofrixionSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, NofrixionResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, NofrixionResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return NofrixionError(code, msg, self)
