...
class NoFrixionMoneyMoovModelsPaymentRequestsMerchantPayment3Entity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return NoFrixionMoneyMoovModelsPaymentRequestsMerchantPayment3Entity(self._client, opts)
    ...
    def data_get(self) -> NoFrixionMoneyMoovModelsPaymentRequestsMerchantPayment3:
    ...
    def match_get(self) -> NoFrixionMoneyMoovModelsPaymentRequestsMerchantPayment3:
    ...
    def update(self, reqdata: NoFrixionMoneyMoovModelsPaymentRequestsMerchantPayment3UpdateData, ctrl=None) -> NoFrixionMoneyMoovModelsPaymentRequestsMerchantPayment3:
