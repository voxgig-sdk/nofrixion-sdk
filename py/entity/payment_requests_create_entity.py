...
class PaymentRequestsCreateEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return PaymentRequestsCreateEntity(self._client, opts)
    ...
    def data_get(self) -> PaymentRequestsCreate:
    ...
    def match_get(self) -> PaymentRequestsCreate:
    ...
    def create(self, reqdata: PaymentRequestsCreateCreateData, ctrl=None) -> PaymentRequestsCreate:
