...
class SendbeneficiaryEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return SendbeneficiaryEntity(self._client, opts)
    ...
    def data_get(self) -> Sendbeneficiary:
    ...
    def match_get(self) -> Sendbeneficiary:
    ...
    def create(self, reqdata: SendbeneficiaryCreateData, ctrl=None) -> Sendbeneficiary:
