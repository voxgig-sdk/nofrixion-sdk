...
class WhoamitrustedappEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return WhoamitrustedappEntity(self._client, opts)
    ...
    def data_get(self) -> Whoamitrustedapp:
    ...
    def match_get(self) -> Whoamitrustedapp:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[Whoamitrustedapp]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.Whoamitrustedapp().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
