...
class PayoutKeysetEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return PayoutKeysetEntity(self._client, opts)
    ...
    def data_get(self) -> PayoutKeyset:
    ...
    def match_get(self) -> PayoutKeyset:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[PayoutKeyset]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.PayoutKeyset().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
