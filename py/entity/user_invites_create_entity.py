...
class UserInvitesCreateEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return UserInvitesCreateEntity(self._client, opts)
    ...
    def data_get(self) -> UserInvitesCreate:
    ...
    def match_get(self) -> UserInvitesCreate:
    ...
    def create(self, reqdata: UserInvitesCreateCreateData, ctrl=None) -> UserInvitesCreate:
