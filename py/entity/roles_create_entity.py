...
class RolesCreateEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return RolesCreateEntity(self._client, opts)
    ...
    def match_get(self) -> RolesCreate:
    ...
    def create(self, reqdata: RolesCreateCreateData, ctrl=None) -> RolesCreate:
