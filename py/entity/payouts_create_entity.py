...
class PayoutsCreateEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return PayoutsCreateEntity(self._client, opts)
    ...
    def data_get(self) -> PayoutsCreate:
    ...
    def match_get(self) -> PayoutsCreate:
    ...
    def create(self, reqdata: PayoutsCreateCreateData, ctrl=None) -> PayoutsCreate:
