...
class MerchantDirectDebitMandateEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return MerchantDirectDebitMandateEntity(self._client, opts)
    ...
    def data_get(self) -> MerchantDirectDebitMandate:
    ...
    def match_get(self) -> MerchantDirectDebitMandate:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[MerchantDirectDebitMandate]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.MerchantDirectDebitMandate().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
