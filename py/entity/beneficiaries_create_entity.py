...
class BeneficiariesCreateEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return BeneficiariesCreateEntity(self._client, opts)
    ...
    def data_get(self) -> BeneficiariesCreate:
    ...
    def match_get(self) -> BeneficiariesCreate:
    ...
    def create(self, reqdata: BeneficiariesCreateCreateData, ctrl=None) -> BeneficiariesCreate:
